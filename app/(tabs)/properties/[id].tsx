...
export default function LocationScreen() {
  ...
  const fetchProperty = () => {
    ...
    console.log(`🚀 ~ [id].tsx:45 ~ fetchProperty ~ id: \n`, id);
    ...
    () => [
      {
        label: "Rooms",
        value: roomsCount,
        route: "/properties/rooms/rooms.screen",
      },
      {
        label: "Checklists",
        value: (property as any)?.checklists?.length ?? 0,
        route: "/properties/checklists/checklists.screen",
      },
      {
        label: "Open Tasks",
        value: (property as any)?.openTasks ?? 0,
        route: "/properties/tasks/tasks.screen",
      },
      {
        label: "Inventory Items",
        value: (property as any)?.inventoryCount ?? 0,
        route: "/properties/inventory/inventory.screen",
      },
    ],
    [property, roomsCount]
  );
      ...
      <TurndownSection
        ...
        right={
          <Button
            ...
            onPress={() =>
              router.push({
                pathname: "/properties/checklists/checklists.screen",
                params: { id },
              })
            }
          >
      ...
      <TurndownSection
        ...
        right={
          <Button
            ...
            onPress={() =>
              router.push({
                pathname: "/properties/rooms/rooms.screen",
                params: { id },
              })
            }
          >
      ...
      <TurndownSection
        ...
        right={
          <Button
            ...
            onPress={() =>
              router.push({
                pathname: "/properties/inventory/inventory.screen",
                params: { id },
              })
            }
          >

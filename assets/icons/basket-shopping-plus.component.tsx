          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 576 512" fill={color}>
                ...
                />
                <Path d="M253.9 33.8 183 192h-52.6l79.7-177.8c5.4-12.1 19.6-17.5 31.7-12.1s17.5 19.6 12.1 31.7m112-19.6L445.6 192H393L322.1 33.8c-5.4-12.1 0-26.3 12.1-31.7s26.3 0 31.7 12.1M264 432v-56h-56c-13.3 0-24-10.7-24-24s10.7-24 24-24h56v-56c0-13.3 10.7-24 24-24s24 10.7 24 24v56h56c13.3 0 24 10.7 24 24s-10.7 24-24 24h-56v56c0 13.3-10.7 24-24 24s-24-10.7-24-24" />
              </Svg>
            );

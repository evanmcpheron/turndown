      ...
      {(() => {
        switch (type) {
          ...
          case "light":
            return (
              <Svg viewBox="0 0 448 512"  fill={colors[colorName || "text"]} >
                <Path d="M87.9 42.9 70.2 96h307.6l-17.7-53.1c-2.2-6.5-8.3-10.9-15.2-10.9H103.1c-6.9 0-13 4.4-15.2 10.9M47.6 128H16c-8.8 0-16-7.2-16-16s7.2-16 16-16h20.5l21-63.2C64.1 13.2 82.4 0 103.1 0h241.8c20.7 0 39 13.2 45.5 32.8L411.5 96H432c8.8 0 16 7.2 16 16s-7.2 16-16 16H47.7zm27 325.9L47.4 160h32.1l5.9 64h277.1l5.9-64h32.1l-27.1 293.9c-3 32.9-30.7 58.1-63.7 58.1H138.3c-33.1 0-60.7-25.2-63.7-58.1m285-197.9H88.4l11.9 128h247.4zm-14.8 160H103.2l3.2 35c1.5 16.5 15.3 29 31.9 29h171.4c16.5 0 30.3-12.6 31.9-29z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 448 512"  fill={colors[colorName || "text"]} >
                ...
                />
                <Path d="M55.2 17.7 32 64C14.3 64 0 78.3 0 96s14.3 32 32 32h384c17.7 0 32-14.3 32-32s-14.3-32-32-32l-23.2-46.3C387.4 6.8 376.3 0 364.2 0H83.8C71.7 0 60.6 6.8 55.2 17.7M378 392l13.3-160H56.7L70 392z" />
              </Svg>
            );

          ...
          case "duotone":
            return (
              ...
              >
                ...
                <path
                  className="aps-icon-foreground"
                  d="M416 176c0 97.2-93.1 176-208 176-38.2 0-73.9-8.7-104.7-23.9-7.5 4-16 7.9-25.3 11.4-18.2 6.9-40.2 12.5-62 12.5-6.9 0-13.1-4.5-15.2-11.1S1 327.1 6.6 323l.2-.2c.2-.2.6-.4 1.1-.8 1-.8 2.5-2 4.3-3.7 3.6-3.3 8.5-8.1 13.3-14.3 5.5-7 10.7-15.4 14.2-24.7C14.7 250.3 0 214.6 0 176 0 78.8 93.1 0 208 0s208 78.8 208 176"
                />
              </svg>
            );

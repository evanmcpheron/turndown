      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 512 512"  fill={colors[colorName || "text"]} >
                <Path d="M220.6 49.7 224 48V32c0-17.7 14.3-32 32-32s32 14.3 32 32v16l3.4 1.7C308.9 58.5 320 76.4 320 96c17.7 0 32 14.3 32 32v16l21.8 21.8c27 27 42.2 63.6 42.2 101.8V448c0 35.3-28.7 64-64 64H160c-35.3 0-64-28.7-64-64V267.6c0-38.2 15.2-74.8 42.2-101.8L160 144v-16c0-17.7 14.3-32 32-32 0-19.6 11.1-37.5 28.6-46.3M368 448V267.6c0-25.5-10.1-49.9-28.1-67.9l-7.8-7.8H179.9l-7.8 7.8c-18 18-28.1 42.4-28.1 67.9v4.4h88c13.3 0 24 10.7 24 24s-10.7 24-24 24h-88v48h88c13.3 0 24 10.7 24 24s-10.7 24-24 24h-88v32c0 8.8 7.2 16 16 16h192c8.8 0 16-7.2 16-16" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512"  fill={colors[colorName || "text"]} >
                ...
                />
                <Path d="M192 96c-17.7 0-32 14.3-32 32v32h192v-32c0-17.7-14.3-32-32-32zm-80 176v48h88c13.3 0 24-10.7 24-24s-10.7-24-24-24zm0 112v48h88c13.3 0 24-10.7 24-24s-10.7-24-24-24z" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 512 512"  fill={colors[colorName || "text"]} >
                <Path d="M0 256a256 256 0 1 1 512 0 256 256 0 1 1-512 0m320 96c0-35.3-28.7-64-64-64-14.1 0-27.2 4.6-37.8 12.4l-117.6-72.8c-11.3-7-26.1-3.5-33 7.8s-3.5 26.1 7.8 33l117.5 72.8q-.9 5.25-.9 10.8c0 35.3 28.7 64 64 64s64-28.7 64-64" />
              </Svg>
            );
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 512 512"  fill={colors[colorName || "text"]} >
                <Path d="M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416m0 464a256 256 0 1 0 0-512 256 256 0 1 0 0 512m56-160c0-30.9-25.1-56-56-56-10.3 0-19.9 2.8-28.2 7.6l-110.2-75.4c-10.9-7.5-25.9-4.7-33.4 6.3s-4.7 25.9 6.3 33.4l110.2 75.4c-.4 2.9-.7 5.8-.7 8.8 0 30.9 25.1 56 56 56s56-25.1 56-56z" />
              </Svg>
            );

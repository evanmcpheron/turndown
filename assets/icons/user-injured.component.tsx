      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 448 512"  fill={colors[colorName || "text"]} >
                <Path d="M224 208c-44.2 0-80-35.8-80-80h160c0 44.2-35.8 80-80 80M150.7 96C163 67.7 191.2 48 224 48c1.2 0 2.5 0 3.7.1L170.2 96zm113.9-37c14.5 8.5 26 21.5 32.8 37h-77.2zM224 256a128 128 0 1 0 0-256 128 128 0 1 0 0 256M49.3 464c4.7-33.3 21.9-62.5 46.7-82.7V464zm246.3 0h-34.3l-32-48H276c15.5 0 28 12.5 28 28 0 7.8-3.2 14.9-8.4 20m37 0c2.2-6.3 3.4-13 3.4-20 0-33.1-26.9-60-60-60h-68l-21.3-32h83c65.7 0 120.1 48.7 129 112zM178.3 304C79.8 304 0 383.8 0 482.3 0 498.7 13.3 512 29.7 512h388.6c16.4 0 29.7-13.3 29.7-29.7 0-98.5-79.8-178.3-178.3-178.3z" />
              </Svg>
            );
          ...
          case "light":
            return (
              <Svg viewBox="0 0 448 512"  fill={colors[colorName || "text"]} >
                <Path d="M320 128c0 53-43 96-96 96s-96-43-96-96c0-5.5.5-10.8 1.3-16h189.4c.9 5.2 1.3 10.5 1.3 16m-12.8-48h-69.6l39.8-31.8c12.2 8.2 22.4 19.1 29.8 31.8m-63.4-46-57.4 46h-45.6c16.6-28.7 47.6-48 83.2-48 6.8 0 13.4.7 19.8 2M352 128a128 128 0 1 0-256 0 128 128 0 1 0 256 0M32 480c.5-33.7 12.4-64.6 32-89v89zm64 0V361.3c12.9-8.8 27.3-15.6 42.7-19.9L226.9 480zm224-32c0 17.7-14.3 32-32 32h-23.2l-40.7-64H288c17.7 0 32 14.3 32 32M80 512h338.3c16.4 0 29.7-13.3 29.7-29.7 0-98.5-79.8-178.3-178.3-178.3h-91.4C79.8 304 0 383.8 0 482.3 0 498.7 13.3 512 29.7 512zm336-32h-72.6c5.4-9.4 8.6-20.3 8.6-32 0-35.3-28.7-64-64-64h-84.3l-30.5-47.9c1.7-.1 3.4-.1 5.1-.1h91.4c80 0 145 64.3 146.3 144" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 448 512"  fill={colors[colorName || "text"]} >
                ...
                />
                <Path d="M348 96c-6.7-25.9-21.3-48.7-41.1-65.5L222.6 96zM224 0c-59.6 0-109.8 40.8-124 96h70.5l107.9-83.9C261.9 4.3 243.4 0 224 0m38.4 512L140.1 308.1c-28.5 6.2-54.5 19.3-76.1 37.3V512z" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 576 512" fill={color}>
                <Path d="M64 96c0-35.3 28.7-64 64-64h320c35.3 0 64 28.7 64 64v150.3l53.3 79.9c7 10.5 10.7 22.9 10.7 35.5V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64v-54.3c0-12.6 3.7-25 10.7-35.5L64 246.3zm224 160a64 64 0 1 0 0-128 64 64 0 1 0 0 128m160-128a32 32 0 1 0-64 0 32 32 0 1 0 64 0M112 384c-8.8 0-16 7.2-16 16s7.2 16 16 16h352c8.8 0 16-7.2 16-16s-7.2-16-16-16z" />
              </Svg>
            );
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 576 512" fill={color}>
                <Path d="M512 432H64c-8.8 0-16-7.2-16-16v-32h480v32c0 8.8-7.2 16-16 16M68.4 336l32.9-49.3c7-10.5 10.7-22.9 10.7-35.5V96c0-8.8 7.2-16 16-16h320c8.8 0 16 7.2 16 16v155.2c0 12.6 3.7 25 10.7 35.5l32.9 49.3zM64 480h448c35.3 0 64-28.7 64-64v-44.6c0-12.6-3.7-25-10.7-35.5L514.7 260c-1.8-2.6-2.7-5.7-2.7-8.9V96c0-35.3-28.7-64-64-64H128c-35.3 0-64 28.7-64 64v155.2c0 3.2-.9 6.2-2.7 8.9l-50.6 75.8C3.7 346.4 0 358.7 0 371.4V416c0 35.3 28.7 64 64 64m344-368a24 24 0 1 0 0 48 24 24 0 1 0 0-48M288 288a80 80 0 1 0 0-160 80 80 0 1 0 0 160m-32-80a32 32 0 1 1 64 0 32 32 0 1 1-64 0" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 576 512" fill={color}>
                ...
                />
                <Path d="M64 96c0-35.3 28.7-64 64-64h320c35.3 0 64 28.7 64 64v150.3l53.3 79.9c5.2 7.8 8.6 16.6 10 25.8H.7c1.4-9.2 4.8-18 10-25.8L64 246.3zm224 160a64 64 0 1 0 0-128 64 64 0 1 0 0 128m160-128a32 32 0 1 0-64 0 32 32 0 1 0 64 0" />
              </Svg>
            );

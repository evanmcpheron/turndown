      ...
      {(() => {
        switch (type) {
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 576 512"  fill={colors[colorName || "text"]} >
                <Path d="M232 72v208c0 4.4-3.6 8-8 8s-8-3.6-8-8V72c0-22.1 17.9-40 40-40h64c22.1 0 40 17.9 40 40v208c0 4.4-3.6 8-8 8s-8-3.6-8-8V72c0-13.3-10.7-24-24-24h-64c-13.3 0-24 10.7-24 24m-40 1.3V90C108.4 117 48 195.5 48 288v32H32v-32c0-101.5 67.5-187.2 160-214.7M384 90V73.3c91.8 27.3 158.9 111.9 160 212.3V320h-16v-34.4c-1-91.5-61.1-168.8-144-195.6m153.3 278H38.7C26.2 368 16 378.2 16 390.7c0 6.6 2.7 11.4 6.6 13.9C50.7 422.7 131.9 464 288 464s237.3-41.3 265.4-59.4c3.8-2.5 6.6-7.3 6.6-13.9 0-12.6-10.2-22.7-22.7-22.7M38.7 352h498.6c21.4 0 38.7 17.3 38.7 38.7 0 11-4.7 21.4-13.9 27.3-30.8 19.9-115 62-274.1 62S44.7 437.9 13.9 418.1C4.7 412.1 0 401.7 0 390.7 0 369.3 17.3 352 38.7 352" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 576 512"  fill={colors[colorName || "text"]} >
                ...
                />
                <Path d="M224 64c0-17.7 14.3-32 32-32h64c17.7 0 32 14.3 32 32v101.9c0 5.6 4.5 10.1 10.1 10.1 3.6 0 7-1.9 8.8-5.1l48-83.9c73.4 36.1 124.2 111.4 125.1 198.6V384H32v-96c0-88.2 51-164.5 125.1-201l48 83.9c1.8 3.2 5.2 5.1 8.8 5.1 5.6 0 10.1-4.5 10.1-10.1V64" />
              </Svg>
            );

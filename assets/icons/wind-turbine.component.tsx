      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 512 512" fill={color}>
                <Path d="M315.7 414.8c9.1 14.8 32 6.5 29.5-10.7L316.9 212c-.5-3.4.1-6.9 1.8-9.9L411 31.2c8.3-15.3-10.4-31-24-20.1L234.7 131.7c-2.7 2.1-6 3.4-9.5 3.5l-194.1 5.4c-17.4.4-21.6 24.4-5.4 30.8l180.6 71.5c3.2 1.3 5.9 3.5 7.7 6.5zm-91.7-88V464h-72c-13.3 0-24 10.7-24 24s10.7 24 24 24h208c13.3 0 24-10.7 24-24s-10.7-24-24-24h-72v-33.2zM256 168a24 24 0 1 1 0 48 24 24 0 1 1 0-48" />
              </Svg>
            );
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 512 512" fill={color}>
                <Path d="M301 214.3c-1-6.8.2-13.8 3.5-19.9l92.4-170.8-152.2 120.6c-5.4 4.3-12.1 6.7-19 6.9l-194.1 5.4L212.2 228c6.4 2.5 11.9 7.1 15.5 13l101.7 165.5zm44.2 189.8c2.5 17.2-20.3 25.5-29.5 10.7L288 369.7l-16-26-32-52-16-26-10-16.3c-1.8-2.9-4.5-5.2-7.7-6.5L25.7 171.4c-16.2-6.4-12-30.4 5.4-30.8l194.1-5.4c3.5-.1 6.8-1.3 9.5-3.5L387 11c13.6-10.8 32.3 4.8 24 20.1L318.6 202c-1.6 3-2.3 6.5-1.8 9.9L345.2 404zM240 352.8V496h32v-91.2l16 26V496h88c4.4 0 8 3.6 8 8s-3.6 8-8 8H136c-4.4 0-8-3.6-8-8s3.6-8 8-8h88V326.8zM256 184a16 16 0 1 1 0 32 16 16 0 1 1 0-32" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512" fill={color}>
                ...
                />
                <Path d="M345.2 404.1c2.5 17.2-20.3 25.5-29.5 10.7L214 249.4c-1.8-2.9-4.5-5.2-7.7-6.5L25.7 171.4c-16.2-6.4-12-30.4 5.4-30.8l194.1-5.4c3.5-.1 6.8-1.3 9.5-3.5L387 11c13.6-10.8 32.3 4.8 24 20.1L318.6 202c-1.6 3-2.3 6.5-1.8 9.9L345.2 404zM256 216a24 24 0 1 0 0-48 24 24 0 1 0 0 48" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 448 512"  fill={colors[colorName || "text"]} >
                <Path d="M178 80h44.4c27.4 0 49.7 22.2 49.7 49.7 0 16.2-7.9 31.4-21.2 40.7l-61.4 43-47.2-48.5C133.1 155.5 128 143 128 130c0-27.6 22.4-50 50-50m45.3 168.2 55.1-38.5c26.1-18.3 41.7-48.1 41.7-80-.1-54-43.8-97.7-97.8-97.7H178c-54.1 0-98 43.9-98 98 0 25.5 10 50 27.7 68.3l41.8 43-73.6 51.5C48.4 312 32 343.5 32 377.1 32 433.9 78.1 480 134.9 480h77.8c35.1 0 67.8-17.7 87-47.1l14.6-22.3 60.4 62.1c9.2 9.5 24.4 9.7 33.9.5s9.7-24.4.5-33.9l-67.9-69.8L412 261.2c7.3-11.1 4.1-26-7-33.2s-26-4.1-33.2 7L307 334.2zm-39.8 27.9 96.6 99.3-20.5 31.3c-10.3 15.8-28 25.4-46.9 25.4h-77.8c-30.3-.1-54.9-24.7-54.9-55 0-17.9 8.7-34.7 23.4-45l80-56z" />
              </Svg>
            );

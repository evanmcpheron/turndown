...
export const CartCircleXmarkIcon: React.FC<
  IconProps & {
          ...
          case "thin":
            return (
              ...
              >
                <path
                  className="aps-icon-foreground"
                  d="M8 0C3.6 0 0 3.6 0 8s3.6 8 8 8h37.7c11.4 0 21.3 8.1 23.5 19.4l59.4 303.4c5.1 26.3 28.2 45.2 55 45.2h137.1c-.5-5.3-.7-10.6-.7-16H183.5c-19.1 0-35.6-13.5-39.3-32.3l-9.3-47.7h204.3c2.8-5.5 5.9-10.8 9.3-16H131.8L88 48h439.7c15.5 0 26.9 14.4 23.4 29.5l-27.3 116.7c5.3.8 10.5 1.9 15.7 3.2l27.1-116.3C572.5 56 553.4 32 527.7 32H84.8C81 13.4 64.7 0 45.7 0zm136 464a32 32 0 1 1 64 0 32 32 0 1 1-64 0m80 0a48 48 0 1 0-96 0 48 48 0 1 0 96 0m144-96a128 128 0 1 1 256 0 128 128 0 1 1-256 0m272 0a144 144 0 1 0-288 0 144 144 0 1 0 288 0m-82.3-50.3c3.1-3.1 3.1-8.2 0-11.3s-8.2-3.1-11.3 0L496 356.7l-50.3-50.3c-3.1-3.1-8.2-3.1-11.3 0s-3.1 8.2 0 11.3l50.3 50.3-50.3 50.3c-3.1 3.1-3.1 8.2 0 11.3s8.2 3.1 11.3 0l50.3-50.3 50.3 50.3c3.1 3.1 8.2 3.1 11.3 0s3.1-8.2 0-11.3L507.3 368l50.3-50.3z"
                />
              </svg>
            );

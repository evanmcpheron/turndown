      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 448 512" fill={color}>
                <Path d="M16 56c0-13.3 10.7-24 24-24h96c13.3 0 24 10.7 24 24s-10.7 24-24 24h-24v144c0 61.9 50.1 112 112 112s112-50.1 112-112V80h-24c-13.3 0-24-10.7-24-24s10.7-24 24-24h96c13.3 0 24 10.7 24 24s-10.7 24-24 24h-24v144c0 88.4-71.6 160-160 160S64 312.4 64 224V80H40c-13.3 0-24-10.7-24-24M0 456c0-13.3 10.7-24 24-24h400c13.3 0 24 10.7 24 24s-10.7 24-24 24H24c-13.3 0-24-10.7-24-24" />
              </Svg>
            );
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 448 512" fill={color}>
                <Path d="M0 40c0-4.4 3.6-8 8-8h128c4.4 0 8 3.6 8 8s-3.6 8-8 8H80v192c0 79.5 64.5 144 144 144s144-64.5 144-144V48h-56c-4.4 0-8-3.6-8-8s3.6-8 8-8h128c4.4 0 8 3.6 8 8s-3.6 8-8 8h-56v192c0 88.4-71.6 160-160 160S64 328.4 64 240V48H8c-4.4 0-8-3.6-8-8m0 432c0-4.4 3.6-8 8-8h432c4.4 0 8 3.6 8 8s-3.6 8-8 8H8c-4.4 0-8-3.6-8-8" />
              </Svg>
            );

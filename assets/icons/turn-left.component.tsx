      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 512 512"  fill={colors[colorName || "text"]} >
                <Path d="M177.5 66c-8.8-3.8-19-2-26 4.6l-144 136C2.7 211.1 0 217.4 0 224s2.7 12.9 7.5 17.4l144 136c7 6.6 17.2 8.4 26 4.6s14.5-12.5 14.5-22v-88h192c17.7 0 32 14.3 32 32v144c0 17.7 14.3 32 32 32h32c17.7 0 32-14.3 32-32V304c0-70.7-57.3-128-128-128H192V88c0-9.6-5.7-18.2-14.5-22" />
              </Svg>
            );
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 512 512"  fill={colors[colorName || "text"]} >
                <Path d="M176 272v89.1c0 3.8-3.1 6.9-6.9 6.9-1.8 0-3.5-.7-4.7-1.9L16.8 225.9c-.5-.5-.8-1.2-.8-1.9s.3-1.4.8-1.9L164.4 81.9c1.3-1.2 3-1.9 4.7-1.9 3.8 0 6.9 3.1 6.9 6.9V176c0 8.8 7.2 16 16 16h208c53 0 96 43 96 96v152c0 13.3-10.7 24-24 24h-16c-13.3 0-24-10.7-24-24V288c0-17.7-14.3-32-32-32H192c-8.8 0-16 7.2-16 16M5.8 237.5l147.6 140.2c4.3 4 9.9 6.3 15.8 6.3 12.6 0 22.9-10.2 22.9-22.9V272h208c8.8 0 16 7.2 16 16v152c0 22.1 17.9 40 40 40h16c22.1 0 40-17.9 40-40V288c0-61.9-50.1-112-112-112h-208V86.9c-.1-12.7-10.3-22.9-23-22.9-5.9 0-11.5 2.3-15.8 6.3L5.8 210.5C2.1 214 0 218.9 0 224s2.1 10 5.8 13.5" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512"  fill={colors[colorName || "text"]} >
                ...
                />
                <Path d="M151.5 70.6c7-6.6 17.2-8.4 26-4.6S192 78.5 192 88v272c0 9.6-5.7 18.2-14.5 22s-19 2-26-4.6l-144-136C2.7 236.9 0 230.6 0 224s2.7-12.9 7.5-17.4z" />
              </Svg>
            );

            ...
            return (
              ...
              >
                <path
                  ...
                  d="M0 256a256 256 0 1 1 512 0 256 256 0 1 1-512 0m320 96q0-5.55-.9-10.8l117.5-72.8c11.3-7 14.7-21.8 7.8-33s-21.8-14.8-33-7.8l-117.6 72.8c-10.6-7.8-23.7-12.4-37.8-12.4-35.3 0-64 28.7-64 64s28.7 64 64 64 64-28.7 64-64"
                />
              </svg>
            );
          ...
          case "regular":
            return (
              ...
              >
                <path
                  className="aps-icon-foreground"
                  d="M256 464a208 208 0 1 0 0-416 208 208 0 1 0 0 416m0-464a256 256 0 1 1 0 512 256 256 0 1 1 0-512m-56 352c0-30.9 25.1-56 56-56 10.3 0 19.9 2.8 28.2 7.6l110.2-75.4c10.9-7.5 25.9-4.7 33.4 6.3s4.7 25.9-6.3 33.4l-110.2 75.3c.4 2.9.7 5.8.7 8.8 0 30.9-25.1 56-56 56s-56-25.1-56-56"
                />
              </svg>
            );

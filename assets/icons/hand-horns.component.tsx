      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 384 512"  fill={colors[colorName || "text"]} >
                <Path d="M80 48c8.8 0 16 7.2 16 16v176H80c-5.5 0-10.8.6-16 1.6V64c0-8.8 7.2-16 16-16M16 64v208C6 285.4 0 302 0 320v24c0 92.8 75.2 168 168 168h48c92.8 0 168-75.2 168-168V128c0-35.3-28.7-64-64-64s-64 28.7-64 64v50c-5.1-1.3-10.5-2-16-2-7.9 0-15.4 1.4-22.4 4-10.4-21.3-32.3-36-57.6-36-5.5 0-10.9.7-16 2V64c0-35.3-28.7-64-64-64S16 28.7 16 64m320 192v88c0 66.3-53.7 120-120 120h-48c-66.3 0-120-53.7-120-120v-24c0-17.7 14.3-32 32-32h80c8.8 0 16 7.2 16 16s-7.2 16-16 16h-40c-13.3 0-24 10.7-24 24s10.7 24 24 24h40c15.1 0 29-5.3 40-14 11 8.8 24.9 14 40 14 35.3 0 64-28.7 64-64V128c0-8.8 7.2-16 16-16s16 7.2 16 16zm-176-16h-16v-32c0-8.8 7.2-16 16-16s16 7.2 16 16v34c-5.1-1.3-10.5-2-16-2m96 16v48c0 8.8-7.2 16-16 16s-16-7.2-16-16v-64c0-8.8 7.2-16 16-16s16 7.2 16 16z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 384 512"  fill={colors[colorName || "text"]} >
                ...
                />
                <Path d="M160 128c-17.7 0-32 14.3-32 32v48c0 17.7 14.3 32 32 32s32-14.3 32-32v-48c0-17.7-14.3-32-32-32m96 32c-17.7 0-32 14.3-32 32v64c0 17.7 14.3 32 32 32s32-14.3 32-32v-64c0-17.7-14.3-32-32-32" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 512 512"  fill={colors[colorName || "text"]} >
                <Path d="M461.6 224H510C495.6 108.2 403.8 16.4 288 2v48.5c89.3 13.7 159.8 84.3 173.6 173.5m48.4 64h-48.4c-13.8 89.3-84.3 159.8-173.6 173.6V510c115.8-14.4 207.6-106.2 222-222M2 288c14.4 115.8 106.2 207.6 222 222v-48.4C134.7 447.8 64.2 377.3 50.4 288zm0-64h48.4C64.2 134.8 134.7 64.2 224 50.5V2C108.2 16.4 16.4 108.2 2 224m190-64c0-13.3-10.7-24-24-24s-24 10.7-24 24v192c0 13.3 10.7 24 24 24s24-10.7 24-24v-72h128v72c0 13.3 10.7 24 24 24s24-10.7 24-24V160c0-13.3-10.7-24-24-24s-24 10.7-24 24v72H192z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512"  fill={colors[colorName || "text"]} >
                ...
                />
                <Path d="M176 128c17.7 0 32 14.3 32 32v64h96v-64c0-17.7 14.3-32 32-32s32 14.3 32 32v192c0 17.7-14.3 32-32 32s-32-14.3-32-32v-64h-96v64c0 17.7-14.3 32-32 32s-32-14.3-32-32V160c0-17.7 14.3-32 32-32" />
              </Svg>
            );

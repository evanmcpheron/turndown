          ...
          case "solid":
            return (
              <Svg viewBox="0 0 640 512"  fill={colors[colorName || "text"]} >
                <Path d="m220.6 17.7 82.3 164.6-35.8 71.6L163.4 46.3c-7.9-15.8-1.5-35 14.3-42.9s35-1.5 42.9 14.3m152.2 304.4 15 29.9H544v160H435.8c-24.2 0-46.4-13.7-57.2-35.4l-41.5-83 35.8-71.6zM576 352h32c17.7 0 32 14.3 32 32v96c0 17.7-14.3 32-32 32h-32zM462.3 3.4c15.8 7.9 22.2 27.1 14.3 42.9L261.5 476.6c-10.8 21.7-33 35.4-57.2 35.4H96V352h156.2L419.4 17.7c7.9-15.8 27.1-22.2 42.9-14.3M0 384c0-17.7 14.3-32 32-32h32v160H32c-17.7 0-32-14.3-32-32z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 640 512"  fill={colors[colorName || "text"]} >
                ...
                />
                <Path d="m220.6 17.7 81.5 163-35.8 71.6-102.9-206c-7.9-15.8-1.5-35 14.3-42.9s35-1.5 42.9 14.3m117.3 377.6 35.8-71.6 14.1 28.3H544v160H435.8c-24.2 0-46.4-13.7-57.2-35.4L338 395.3zM608 352c17.7 0 32 14.3 32 32v96c0 17.7-14.3 32-32 32h-32V352zm-512 0v160H64V352z" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 448 512" fill={color}>
                <Path d="M8 56c-4.4 0-8 3.6-8 8s3.6 8 8 8h272c4.4 0 8-3.6 8-8s-3.6-8-8-8zm0 128c-4.4 0-8 3.6-8 8s3.6 8 8 8h432c4.4 0 8-3.6 8-8s-3.6-8-8-8zM0 320c0 4.4 3.6 8 8 8h272c4.4 0 8-3.6 8-8s-3.6-8-8-8H8c-4.4 0-8 3.6-8 8m8 120c-4.4 0-8 3.6-8 8s3.6 8 8 8h432c4.4 0 8-3.6 8-8s-3.6-8-8-8z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 448 512" fill={color}>
                ...
                />
                <Path d="M416 480c17.7 0 32-14.3 32-32s-14.3-32-32-32H32c-17.7 0-32 14.3-32 32s14.3 32 32 32zm0-256c17.7 0 32-14.3 32-32s-14.3-32-32-32H32c-17.7 0-32 14.3-32 32s14.3 32 32 32z" />
              </Svg>
            );

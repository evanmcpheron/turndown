      ...
      {(() => {
        switch (type) {
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 384 512" fill={color}>
                <Path d="M24 32c4.4 0 8 3.6 8 8v264c0 88.4 71.6 160 160 160s160-71.6 160-160V40c0-4.4 3.6-8 8-8s8 3.6 8 8v264c0 97.2-78.8 176-176 176S16 401.2 16 304V40c0-4.4 3.6-8 8-8" />
              </Svg>
            );

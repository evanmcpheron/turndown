          ...
          case "duotone":
            return (
              ...
              >
                ...
                <path
                  className="aps-icon-foreground"
                  d="M352 176v137.4c0 12.5-10.1 22.6-22.6 22.6-6 0-11.8-2.4-16-6.6L280 296l-66.3 66.3c-3.7 3.7-8.6 5.7-13.7 5.7s-10-2-13.7-5.7l-36.7-36.7c-3.6-3.6-5.6-8.5-5.6-13.6s2-10 5.7-13.7L216 232l-33.4-33.4c-4.2-4.2-6.6-10-6.6-16 0-12.5 10.1-22.6 22.6-22.6H336c8.8 0 16 7.2 16 16"
                />
              </svg>
            );

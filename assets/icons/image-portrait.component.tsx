          ...
          case "solid":
            return (
              <Svg viewBox="0 0 384 512" fill={color}>
                <Path d="M384 64c0-35.3-28.7-64-64-64H64C28.7 0 0 28.7 0 64v384c0 35.3 28.7 64 64 64h256c35.3 0 64-28.7 64-64zM128 192a64 64 0 1 1 128 0 64 64 0 1 1-128 0M80 356.6c0-37.9 30.7-68.6 68.6-68.6h86.9c37.9 0 68.6 30.7 68.6 68.6 0 15.1-12.3 27.4-27.4 27.4H107.4C92.3 384 80 371.7 80 356.6" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 384 512" fill={color}>
                ...
                />
                <Path d="M192 256a64 64 0 1 0 0-128 64 64 0 1 0 0 128m-43.4 32c-37.9 0-68.6 30.7-68.6 68.6 0 15.1 12.3 27.4 27.4 27.4h169.2c15.1 0 27.4-12.3 27.4-27.4 0-37.9-30.7-68.6-68.6-68.6z" />
              </Svg>
            );

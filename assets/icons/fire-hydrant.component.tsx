      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 384 512"  fill={colors[colorName || "text"]} >
                <Path d="M192 0c-17.7 0-32 14.3-32 32v4c-45 11.6-80.4 47-92 92H56c-13.3 0-24 10.7-24 24s10.7 24 24 24h272c13.3 0 24-10.7 24-24s-10.7-24-24-24h-12c-11.6-45-47-80.4-92-92v-4c0-17.7-14.3-32-32-32M56 464c-13.3 0-24 10.7-24 24s10.7 24 24 24h272c13.3 0 24-10.7 24-24s-10.7-24-24-24h-8v-80h16c17.7 0 32-14.3 32-32v-64c0-17.7-14.3-32-32-32h-16v-48h-48v256H112V208H64v48H48c-17.7 0-32 14.3-32 32v64c0 17.7 14.3 32 32 32h16v80zm192-144a56 56 0 1 0-112 0 56 56 0 1 0 112 0" />
              </Svg>
            );
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 384 512"  fill={colors[colorName || "text"]} >
                <Path d="M192 0c-4.4 0-8 3.6-8 8v24.2C122.4 36 72.5 83.5 65 144H40c-4.4 0-8 3.6-8 8s3.6 8 8 8h304c4.4 0 8-3.6 8-8s-3.6-8-8-8h-25c-7.5-60.5-57.4-108-119-111.8V8c0-4.4-3.6-8-8-8m0 48c56.4 0 103.1 41.7 110.9 96H81.1c7.8-54.3 54.5-96 110.9-96m80 272a80 80 0 1 0-160 0 80 80 0 1 0 160 0m-80-64a64 64 0 1 1 0 128 64 64 0 1 1 0-128M40 496c-4.4 0-8 3.6-8 8s3.6 8 8 8h304c4.4 0 8-3.6 8-8s-3.6-8-8-8h-24V392h24c22.1 0 40-17.9 40-40v-64c0-22.1-17.9-40-40-40h-24v-56h-16v304H80V192H64v56H40c-22.1 0-40 17.9-40 40v64c0 22.1 17.9 40 40 40h24v104zm24-120H40c-13.3 0-24-10.7-24-24v-64c0-13.3 10.7-24 24-24h24zm256 0V264h24c13.3 0 24 10.7 24 24v64c0 13.3-10.7 24-24 24z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 384 512"  fill={colors[colorName || "text"]} >
                ...
                />
                <Path d="M64 176h256v288h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H56c-13.3 0-24-10.7-24-24s10.7-24 24-24h8zm128 224a64 64 0 1 0 0-128 64 64 0 1 0 0 128" />
              </Svg>
            );

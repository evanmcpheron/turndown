      ...
      {(() => {
        switch (type) {
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 512 512" fill={color}>
                <Path d="M64 496h224c26.5 0 48-21.5 48-48v-64h16v64c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V224c0-35.3 28.7-64 64-64h64v16H64c-26.5 0-48 21.5-48 48v224c0 26.5 21.5 48 48 48m112-208c0 26.5 21.5 48 48 48h224c26.5 0 48-21.5 48-48V64c0-26.5-21.5-48-48-48H224c-26.5 0-48 21.5-48 48zm-16 0V64c0-35.3 28.7-64 64-64h224c35.3 0 64 28.7 64 64v224c0 35.3-28.7 64-64 64H224c-35.3 0-64-28.7-64-64" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512" fill={color}>
                ...
                />
                <Path d="M160 288c0 35.3 28.7 64 64 64h224c35.3 0 64-28.7 64-64V64c0-35.3-28.7-64-64-64H224c-35.3 0-64 28.7-64 64z" />
              </Svg>
            );

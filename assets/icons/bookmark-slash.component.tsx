      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 640 512"  fill={colors[colorName || "text"]} >
                <Path d="M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2s-6.3 25.5 4.1 33.7l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L512 376V48c0-26.5-21.5-48-48-48H176c-26.5 0-48 21.5-48 48v27zm471 492.6L128 196.8v290.9c0 13.4 10.9 24.3 24.3 24.3 5 0 9.9-1.5 14-4.4L320 400l153.7 107.6c4.1 2.9 9 4.4 14 4.4 9.9 0 18.4-5.9 22.2-14.3z" />
              </Svg>
            );
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 640 512"  fill={colors[colorName || "text"]} >
                <Path d="M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2s-6.3 25.5 4.1 33.7l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L512 376V48c0-26.5-21.5-48-48-48H176c-26.5 0-48 21.5-48 48v27zM176 112.6V48h288v290.4zm333.9 385.2L315.3 344.5c-3.3.6-6.5 2-9.3 4l-130 92.9V234.7l-48-37.8V488c0 9 5 17.2 13 21.3s17.6 3.4 24.9-1.8l154.1-110 154.1 110c7.3 5.2 16.9 5.9 24.9 1.8 4.9-2.5 8.8-6.7 10.9-11.6z" />
              </Svg>
            );

          ...
          case "duotone":
            return (
              ...
              >
                ...
                <path
                  className="aps-icon-foreground"
                  d="M256 320a64 64 0 1 0 0-128 64 64 0 1 0 0 128m-58.7 32c-29.5 0-53.3 23.9-53.3 53.3 0 5.9 4.8 10.7 10.7 10.7h202.6c5.9 0 10.7-4.8 10.7-10.7 0-29.5-23.9-53.3-53.3-53.3z"
                />
              </svg>
            );

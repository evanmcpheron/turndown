      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 576 512" fill={color}>
                <Path d="M184 296.6v-48l22.5-16.2 113 113-16.1 22.6h-48c-12.7 0-24.9 5.1-33.9 14.1l-38.1 38.1-51.5-51.5 38.1-38.1c9-9 14.1-21.2 14.1-33.9zM502.8 90.2 347.9 306 246 204.1 461.8 49.2c1.1-.8 2.4-1.2 3.7-1.2 1.7 0 3.3.7 4.5 1.9L502.1 82c1.2 1.2 1.9 2.8 1.9 4.5 0 1.3-.4 2.6-1.2 3.7M255.4 416h48c15.5 0 30-7.4 39-20l199.4-277.8c6.6-9.2 10.2-20.3 10.2-31.7 0-14.4-5.7-28.2-15.9-38.4l-32.2-32.2C493.7 5.7 479.9 0 465.5 0c-11.4 0-22.5 3.6-31.7 10.2L156 209.6c-12.6 9-20 23.5-20 39v48l-43.7 43.7c-10.7 10.7-14.1 26-10.1 39.5L9.4 452.7c-6 6-9.4 14.1-9.4 22.6v4.7c0 17.7 14.3 32 32 32h84.7c8.5 0 16.6-3.4 22.6-9.4l32.8-32.8c13.6 4 28.8.6 39.5-10.1zm-120.7 23.3L110.1 464H65.9l46.7-46.7 22.1 22.1z" />
              </Svg>
            );

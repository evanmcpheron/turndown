            ...
            return (
              ...
              >
                <path
                  ...
                  d="M246.6 41.4c-12.5-12.5-32.8-12.5-45.3 0l-128 128c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l73.4-73.4V320c0 17.7 14.3 32 32 32s32-14.3 32-32V141.3l73.4 73.4c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-128-128zM32 416a32 32 0 1 0 0 64 32 32 0 1 0 0-64m96 0a32 32 0 1 0 0 64 32 32 0 1 0 0-64m128 32a32 32 0 1 0-64 0 32 32 0 1 0 64 0m64-32a32 32 0 1 0 0 64 32 32 0 1 0 0-64m64 32a32 32 0 1 0 64 0 32 32 0 1 0-64 0"
                />
              </svg>
            );
          ...
          case "light":
            return (
              ...
              >
                <path
                  className="aps-icon-foreground"
                  d="M235.3 36.7c-6.2-6.2-16.4-6.2-22.6 0l-128 128c-6.2 6.2-6.2 16.4 0 22.6s16.4 6.2 22.6 0L208 86.6V336c0 8.8 7.2 16 16 16s16-7.2 16-16V86.6l100.7 100.7c6.2 6.2 16.4 6.2 22.6 0s6.2-16.4 0-22.6zM32 472a24 24 0 1 0 0-48 24 24 0 1 0 0 48m384 0a24 24 0 1 0 0-48 24 24 0 1 0 0 48m-264-24a24 24 0 1 0-48 0 24 24 0 1 0 48 0m72 24a24 24 0 1 0 0-48 24 24 0 1 0 0 48m120-24a24 24 0 1 0-48 0 24 24 0 1 0 48 0"
                />
              </svg>
            );
          ...
          case "duotone":
            return (
              ...
              >
                ...
                <path
                  className="aps-icon-foreground"
                  d="M201.4 41.4c12.5-12.5 32.8-12.5 45.3 0l128 128c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L256 141.3V320c0 17.7-14.3 32-32 32s-32-14.3-32-32V141.3l-73.4 73.4c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l128-128z"
                />
              </svg>
            );

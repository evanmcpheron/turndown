            ...
            return (
              ...
              >
                <path
                  ...
                  d="M288 0c-12.2.1-23.3 7-28.6 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329l-24.6 145.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3L288 439.8zm141.9 512c1.1.1 2.1.1 3.2 0z"
                />
              </svg>
            );
          ...
          case "regular":
            return (
              ...
              >
                <path
                  className="aps-icon-foreground"
                  d="M293.3.6c10.9 2.5 18.6 12.2 18.6 23.4v384.7c0 8.9-4.9 17-12.7 21.2L151 509.1c-8.1 4.3-17.9 3.7-25.3-1.7s-11.2-14.5-9.7-23.5l26.2-155.6-111.1-110c-6.5-6.4-8.7-15.9-5.9-24.5s10.3-14.9 19.3-16.3l153.2-22.6 68.6-141.4c4.9-10.1 16.1-15.4 27-12.9m-29.4 127.8-28.6 58.8c-3.5 7.1-10.2 12.1-18.1 13.3L99 217.9l85.9 85.1c5.5 5.5 8.1 13.3 6.8 21l-20.3 119.7 92.5-49.4z"
                />
              </svg>
            );
          ...
          case "light":
            return (
              ...
              >
                <path
                  className="aps-icon-foreground"
                  d="M226.5 168.8c-4.6 9.5-13.6 16.1-24.1 17.7L65 206.8l99.8 98.8c7.4 7.3 10.8 17.8 9 28.1l-23.6 139.5 129.7-69.3V58.8zM293.3.6c10.9 2.5 18.6 12.2 18.6 23.4v384.7c0 8.9-4.9 17-12.7 21.2L151 509.1c-8.1 4.3-17.9 3.7-25.3-1.7s-11.2-14.5-9.7-23.5l26.2-155.6-111.1-110c-6.5-6.4-8.7-15.9-5.9-24.5s10.3-14.9 19.3-16.3l153.2-22.6 68.6-141.4c4.9-10.1 16.1-15.4 27-12.9"
                />
              </svg>
            );

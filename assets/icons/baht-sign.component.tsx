      ...
      {(() => {
        switch (type) {
          ...
          case "light":
            return (
              <Svg viewBox="0 0 320 512" fill={color}>
                <Path d="M144 0c-8.8 0-16 7.2-16 16v48H37.6C16.8 64 0 80.8 0 101.6v304.7c0 23 18.7 41.7 41.7 41.7H128v48c0 8.8 7.2 16 16 16s16-7.2 16-16v-48h56c57.4 0 104-46.6 104-104 0-44.7-28.2-82.8-67.8-97.5 21.9-19.1 35.8-47.2 35.8-78.5 0-57.4-46.6-104-104-104h-24V16c0-8.8-7.2-16-16-16m-16 96v144H32V101.6c0-3.1 2.5-5.6 5.6-5.6zm32 144V96h24c39.8 0 72 32.2 72 72s-32.2 72-72 72zm-32 32v144H41.7c-5.4 0-9.7-4.4-9.7-9.7V272zm32 144V272h56c39.8 0 72 32.2 72 72s-32.2 72-72 72z" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 448 512" fill={color}>
                <Path d="M96 0C43 0 0 43 0 96v256c0 48 35.2 87.7 81.1 94.9l-46 46c-7 7-2 19.1 7.9 19.1h39.7c8.5 0 16.6-3.4 22.6-9.4L160 448h128l54.6 54.6c6 6 14.1 9.4 22.6 9.4H405c10 0 15-12.1 7.9-19.1l-46-46c46-7.1 81.1-46.9 81.1-94.9V96c0-53-43-96-96-96zM64 96c0-17.7 14.3-32 32-32h256c17.7 0 32 14.3 32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32zm160 192a48 48 0 1 1 0 96 48 48 0 1 1 0-96" />
              </Svg>
            );
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 448 512" fill={color}>
                <Path d="M352 48c26.5 0 48 21.5 48 48v96H48V96c0-26.5 21.5-48 48-48zM48 352V240h352v112c0 26.5-21.5 48-48 48H96c-26.5 0-48-21.5-48-48M96 0C43 0 0 43 0 96v256c0 42.8 28 79 66.6 91.4L39 471c-9.4 9.4-9.4 24.6 0 33.9s24.6 9.4 33.9 0l57-57h188.2l57 57c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-27.6-27.6C420 431 448 394.8 448 352V96c0-53-43-96-96-96zm128 360a40 40 0 1 0 0-80 40 40 0 1 0 0 80" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 448 512" fill={color}>
                ...
                />
                <Path d="M0 96C0 43 43 0 96 0h256c53 0 96 43 96 96v256c0 53-43 96-96 96H96c-53 0-96-43-96-96zm64 0v96c0 17.7 14.3 32 32 32h256c17.7 0 32-14.3 32-32V96c0-17.7-14.3-32-32-32H96c-17.7 0-32 14.3-32 32m160 288a48 48 0 1 0 0-96 48 48 0 1 0 0 96" />
              </Svg>
            );

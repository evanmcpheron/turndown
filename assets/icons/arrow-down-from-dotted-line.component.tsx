      ...
      {(() => {
        switch (type) {
          ...
          case "light":
            return (
              <Svg viewBox="0 0 448 512"  fill={colors[colorName || "text"]} >
                <Path d="M235.3 475.3c-6.2 6.2-16.4 6.2-22.6 0l-128-128c-6.2-6.2-6.2-16.4 0-22.6s16.4-6.2 22.6 0L208 425.4V176c0-8.8 7.2-16 16-16s16 7.2 16 16v249.4l100.7-100.7c6.2-6.2 16.4-6.2 22.6 0s6.2 16.4 0 22.6zM32 88a24 24 0 1 1 0-48 24 24 0 1 1 0 48m384 0a24 24 0 1 1 0-48 24 24 0 1 1 0 48M104 64a24 24 0 1 1 48 0 24 24 0 1 1-48 0m120 24a24 24 0 1 1 0-48 24 24 0 1 1 0 48m72-24a24 24 0 1 1 48 0 24 24 0 1 1-48 0" />
              </Svg>
            );
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 448 512"  fill={colors[colorName || "text"]} >
                <Path d="M16 64a16 16 0 1 1 32 0 16 16 0 1 1-32 0m112-16a16 16 0 1 1 0 32 16 16 0 1 1 0-32m96 0a16 16 0 1 1 0 32 16 16 0 1 1 0-32m96 0a16 16 0 1 1 0 32 16 16 0 1 1 0-32m80 16a16 16 0 1 1 32 0 16 16 0 1 1-32 0m-34.3 277.7-136 136c-3.1 3.1-8.2 3.1-11.3 0l-136-136c-3.1-3.1-3.1-8.2 0-11.3s8.2-3.1 11.3 0L216 452.7V168c0-4.4 3.6-8 8-8s8 3.6 8 8v284.7l122.3-122.4c3.1-3.1 8.2-3.1 11.3 0s3.1 8.2 0 11.3z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 448 512"  fill={colors[colorName || "text"]} >
                ...
                />
                <Path d="M201.4 470.6c12.5 12.5 32.8 12.5 45.3 0l128-128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 370.7V192c0-17.7-14.3-32-32-32s-32 14.3-32 32v178.7l-73.4-73.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128z" />
              </Svg>
            );

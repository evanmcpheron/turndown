          ...
          case "duotone":
            return (
              ...
              >
                ...
                <path
                  className="aps-icon-foreground"
                  d="M322.7 320.9c8.5-14.3 13.3-31 13.3-48.9 0-53-43-96-96-96s-96 43-96 96 43 96 96 96c17.8 0 34.4-4.8 48.7-13.2l38.3 38.3c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-38.3-38.3zM192 272a48 48 0 1 1 96 0 48 48 0 1 1-96 0"
                />
              </svg>
            );

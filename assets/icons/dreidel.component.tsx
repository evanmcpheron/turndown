          ...
          case "solid":
            return (
              <Svg viewBox="0 0 448 512" fill={color}>
                <Path d="M438.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L288 146.7l-62.1-62C207.2 66 176.8 66 158 84.7l-57.4 57.4 237.3 237.2 57.4-57.4c18.7-18.7 18.7-49.1 0-67.9l-62-62zM315.3 401.9 78.1 164.7 18.7 224C6.7 236 0 252.3 0 269.3V416c0 35.3 28.7 64 64 64h146.7c17 0 33.3-6.7 45.3-18.7l59.3-59.3z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 448 512" fill={color}>
                ...
                />
                <Path d="M326.6 390.6 89.4 153.4 18.7 224C6.7 236 0 252.3 0 269.3V416c0 35.3 28.7 64 64 64h146.7c17 0 33.3-6.7 45.3-18.7l70.6-70.6z" />
              </Svg>
            );

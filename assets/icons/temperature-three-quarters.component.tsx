...
export const TemperatureThreeQuartersIcon: React.FC<
  IconProps & {
          ...
          case "regular":
            return (
              ...
              >
                <path
                  className="aps-icon-foreground"
                  d="M160 48c-35.3 0-64 28.7-64 64v161.9c0 14.5-5.7 27.1-12.8 36.6C71.1 326.5 64 346.4 64 368c0 53 43 96 96 96s96-43 96-96c0-21.6-7.1-41.5-19.2-57.5-7.1-9.5-12.8-22.1-12.8-36.6V112c0-35.3-28.7-64-64-64M48 112C48 50.2 98.1 0 160 0s112 50.1 112 112v161.9c0 1.7.7 4.4 3.2 7.8 18.1 24.1 28.8 54 28.8 86.4 0 79.5-64.5 144-144 144S16 447.5 16 368c0-32.4 10.7-62.3 28.8-86.4 2.5-3.4 3.2-6.1 3.2-7.8zm160 256c0 26.5-21.5 48-48 48s-48-21.5-48-48c0-20.9 13.4-38.7 32-45.3V152c0-8.8 7.2-16 16-16s16 7.2 16 16v170.7c18.6 6.6 32 24.4 32 45.3"
                />
              </svg>
            );
          ...
          case "duotone":
            return (
              ...
              >
                ...
                <path
                  className="aps-icon-foreground"
                  d="M176 176c0-8.8-7.2-16-16-16s-16 7.2-16 16v146.7c-18.6 6.6-32 24.4-32 45.3 0 26.5 21.5 48 48 48s48-21.5 48-48c0-20.9-13.4-38.7-32-45.3z"
                />
              </svg>
            );

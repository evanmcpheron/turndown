      ...
      {(() => {
        switch (type) {
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M264 8c0-4.4-3.6-8-8-8s-8 3.6-8 8v24.1C121.1 36 17.4 132.3 2 256.1-.2 273.6 14.3 288 32 288h448c17.7 0 32.2-14.4 30-31.9C494.6 132.3 391 36 264 32.1zm0 454.2V320h-16v142.2c0 18.7-15.2 33.8-33.8 33.8-14.6 0-27.5-9.3-32.1-23.1l-6.5-19.4c-1.4-4.2-5.9-6.5-10.1-5.1s-6.5 5.9-5.1 10.1l6.5 19.4c6.8 20.4 25.8 34.1 47.3 34.1 27.5 0 49.8-22.3 49.8-49.8M17.9 258C32.6 139.6 133.6 48 256 48s223.4 91.6 238.2 210c.8 6.7-4.7 14-14.2 14H32c-9.4 0-15-7.3-14.1-14" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32v2C108.2 48.4 16.4 140.2 2 256.1-.2 273.6 14.3 288 32 288h448c17.7 0 32.2-14.4 30-31.9C495.6 140.2 403.8 48.4 288 34z" />
              </Svg>
            );

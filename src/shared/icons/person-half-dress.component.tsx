          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 320 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M160 96V0c-26.5 0-48 21.5-48 48s21.5 48 48 48m0 32h-5.8c-39.3 0-75.7 20.6-96 54.3L4.6 271.5c-9.1 15.1-4.2 34.8 10.9 43.9s34.8 4.2 43.9-10.9l33.9-56.3L55 362.9c-3.4 10.4 4.3 21.1 15.2 21.1H88v96c0 17.7 14.3 32 32 32s32-14.3 32-32v-96h8z" />
              </Svg>
            );

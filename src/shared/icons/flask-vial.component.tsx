          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M480 0H320c-17.7 0-32 14.3-32 32s14.3 32 32 32v150.9L202.3 406.2a69.54 69.54 0 0 0-10.3 36.4c0 38.3 31.1 69.4 69.4 69.4h309.2c38.3 0 69.4-31.1 69.4-69.4 0-12.8-3.6-25.4-10.3-36.4L512 214.9V64c17.7 0 32-14.3 32-32S529.7 0 512 0zm-96 224V64h64v160c0 5.9 1.6 11.7 4.7 16.8l48.8 79.2h-171l48.8-79.2c3.1-5 4.7-10.8 4.7-16.8" />
              </Svg>
            );

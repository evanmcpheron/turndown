      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M384 48v80c0 5.9-3.2 11.3-8.5 14.1s-11.5 2.5-16.4-.8L320 115.2l-39.1 26.1c-4.9 3.3-11.2 3.6-16.4.8s-8.5-8.2-8.5-14.1V48h-80v192h288V48zm-256 0c0-26.5 21.5-48 48-48h288c26.5 0 48 21.5 48 48v192c0 26.5-21.5 48-48 48H176c-26.5 0-48-21.5-48-48zM0 344c0-13.3 10.7-24 24-24h592c13.3 0 24 10.7 24 24s-10.7 24-24 24h-40v96h40c13.3 0 24 10.7 24 24s-10.7 24-24 24H24c-13.3 0-24-10.7-24-24s10.7-24 24-24h40v-96H24c-13.3 0-24-10.7-24-24m112 120h184v-96H112zm232 0h184v-96H344z" />
              </Svg>
            );

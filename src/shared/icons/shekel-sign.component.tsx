      ...
      {(() => {
        switch (type) {
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                <Path d="M56 32c-22.1 0-40 17.9-40 40v400c0 4.4 3.6 8 8 8s8-3.6 8-8V72c0-13.3 10.7-24 24-24h136c48.6 0 88 39.4 88 88v216c0 4.4 3.6 8 8 8s8-3.6 8-8V136c0-57.4-46.6-104-104-104zm272 448c57.4 0 104-46.6 104-104V40c0-4.4-3.6-8-8-8s-8 3.6-8 8v336c0 48.6-39.4 88-88 88H192c-13.3 0-24-10.7-24-24V168c0-4.4-3.6-8-8-8s-8 3.6-8 8v272c0 22.1 17.9 40 40 40z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M0 64c0-17.7 14.3-32 32-32h160c70.7 0 128 57.3 128 128v160c0 17.7-14.3 32-32 32s-32-14.3-32-32V160c0-35.3-28.7-64-64-64H64v352c0 17.7-14.3 32-32 32S0 465.7 0 448z" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 384 512" fill={colors[colorName || "text"]}>
                <Path d="M122.5 13.3C126.6 5.1 134.9 0 144 0h96c9.1 0 17.4 5.1 21.5 13.3l24 48c3.5 7.1 3.4 15.5-.5 22.4l-30.4 54.8C329.9 164.4 384 235.9 384 320c0 106-86 192-192 192S0 426 0 320c0-84.1 54.1-155.6 129.4-181.6L99 83.7c-3.8-6.9-4-15.3-.5-22.4zM192 192a128 128 0 1 0 0 256 128 128 0 1 0 0-256" />
              </Svg>
            );
          ...
          case "light":
            return (
              <Svg viewBox="0 0 384 512" fill={colors[colorName || "text"]}>
                <Path d="M136 0c-5.7 0-11 3.1-13.9 8.1l-32 56c-3 5.3-2.8 11.8.6 16.8l38.4 57.7C54 164.6 0 236 0 320c0 106 86 192 192 192s192-86 192-192c0-84-54-155.4-129.1-181.5l38.4-57.7c3.4-5 3.6-11.6.6-16.8l-32-56c-2.9-4.9-8.2-8-13.9-8zm85.9 130.3c-9.7-1.5-19.7-2.3-29.9-2.3s-20.2.8-29.9 2.3l-39.3-59L145.3 32h93.4l22.5 39.4-39.3 59zM32 320a160 160 0 1 1 320 0 160 160 0 1 1-320 0" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 384 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M192 192a128 128 0 1 0 0 256 128 128 0 1 0 0-256m192 128a192 192 0 1 1-384 0 192 192 0 1 1 384 0" />
              </Svg>
            );

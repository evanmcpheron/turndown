          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M60.6 220.6c-14.5-14.5-38.8-11.8-46.3 7.3C5.1 251.5 0 277.1 0 304c0 114.9 93.1 208 208 208 26.9 0 52.5-5.1 76.1-14.4 19-7.5 21.8-31.8 7.3-46.3l-104.1-104 28.4-28.4c2.6.7 5.4 1.1 8.3 1.1 17.7 0 32-14.3 32-32s-14.3-32-32-32-32 14.3-32 32c0 2.9.4 5.6 1.1 8.3l-28.4 28.4z" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M269.4 2.9C265.2 1 260.7 0 256 0s-9.2 1-13.4 2.9L54.3 82.8c-22 9.3-38.4 31-38.3 57.2.5 99.2 41.3 280.7 213.6 363.2 16.7 8 36.1 8 52.8 0C454.7 420.7 495.5 239.2 496 140c.1-26.2-16.3-47.9-38.3-57.2zM80 141.4l176-74.6V224H90.1c-6.9-30-9.8-58.5-10.1-82.6m176 303.4V224h166c-18.5 80.5-65.5 172.2-166 220.8" />
              </Svg>
            );
          ...
          case "light":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M66.8 112.3C55.5 117 47.9 127.7 48 139.8c.1 20 1.9 43.2 6.3 68.2H240V38.8zM61.1 240c21.2 84.6 72.2 180.1 178.9 232.6V240zm210.9 0v232.6c106.7-52.5 157.7-148 179-232.6zm185.8-32c4.3-24.9 6.2-48.2 6.3-68.2.1-12.1-7.5-22.8-18.8-27.6L272 38.8V208zM231 7.8c16-6.8 34-6.8 50 0l176.7 75c22 9.3 38.4 31 38.3 57.2-.5 99.2-41.3 280.7-213.6 363.2-16.7 8-36.1 8-52.8 0C57.3 420.7 16.5 239.2 16 140c-.1-26.2 16.3-47.9 38.3-57.2z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M256.4 0h.3c4.6 0 9.2 1 13.4 2.9l188.3 79.9c22 9.3 38.4 31 38.3 57.2-.1 24-2.6 52.9-8.7 84H256.7V0h-1.4 1zm-26.8 503.2C99 440.7 44 321.3 24.7 224H256v285.1c-9 0-18.1-2-26.4-6z" />
              </Svg>
            );

          ...
          case "solid":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M160 32a104 104 0 1 1 0 208 104 104 0 1 1 0-208m320 0a104 104 0 1 1 0 208 104 104 0 1 1 0-208M0 416c0-70.7 57.3-128 128-128h64c70.7 0 128 57.3 128 128v16c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48zm448 64c-38.3 0-72.7-16.8-96.1-43.5.1-1.5.1-3 .1-4.5v-16c0-34.9-11.2-67.1-30.1-93.4 5.8-20 24.2-34.6 46.1-34.6h224c26.5 0 48 21.5 48 48v16c0 70.7-57.3 128-128 128z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M160 240a104 104 0 1 0 0-208 104 104 0 1 0 0 208m-32 48C57.3 288 0 345.3 0 416v16c0 26.5 21.5 48 48 48h224c26.5 0 48-21.5 48-48v-16c0-70.7-57.3-128-128-128z" />
              </Svg>
            );

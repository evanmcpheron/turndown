      ...
      {(() => {
        switch (type) {
          ...
          case "light":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M25.9 3.4C19-2 8.9-.8 3.4 6.1s-4.2 17 2.7 22.5l608 480c6.9 5.5 17 4.3 22.5-2.6s4.3-17-2.6-22.5zM576 96c0-35.3-28.7-64-64-64H139.6l40.5 32H512c17.7 0 32 14.3 32 32v169.4l-67.7-67.7c-15.6-15.6-40.9-15.6-56.6 0l-31 31 25.3 20 28.4-28.4c3.1-3.1 8.2-3.1 11.3 0l90.3 90.3v40.7l32 25.3zM297.6 319.8l-9.6 9.6-67.7-67.7c-15.6-15.6-40.9-15.6-56.6 0L96 329.4V160.7l-32-25.3V416c0 35.3 28.7 64 64 64h372.4l-40.5-32H214.6l108.2-108.2-25.3-20zM265.4 352l-96 96H128c-17.7 0-32-14.3-32-32v-41.4l90.3-90.3c3.1-3.1 8.2-3.1 11.3 0z" />
              </Svg>
            );

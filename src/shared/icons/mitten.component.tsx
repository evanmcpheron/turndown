          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="m314.7 234.7-31.5-125.8C267.2 44.9 209.7 0 143.8 0h-3.4C62.8 0 0 62.8 0 140.3c0 13 1.8 26 5.4 38.6L64 384h288l79.2-85.8c10.8-11.7 16.8-27 16.8-42.9 0-34.9-28.3-63.3-63.3-63.3H382c-19 0-37.2 8.2-49.7 22.6z" />
              </Svg>
            );

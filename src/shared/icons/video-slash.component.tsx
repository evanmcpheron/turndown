      ...
      {(() => {
        switch (type) {
          ...
          case "light":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M25.9 3.4C19-2 8.9-.8 3.4 6.1s-4.2 17 2.7 22.5l608 480c6.9 5.5 17 4.3 22.5-2.6s4.3-17-2.6-22.5zM416 175.2V128c0-35.3-28.7-64-64-64H180.1l40.5 32H352c17.7 0 32 14.3 32 32v97l32 25.3v-75zM64 384V135.4l-29.9-23.6Q32 119.6 32 128v256c0 35.3 28.7 64 64 64h256c26.4 0 49-16 58.8-38.8l-27.1-21.4c-1.9 15.9-15.3 28.2-31.7 28.2H96c-17.7 0-32-14.3-32-32m512-249.8v242.4l26.5 20.9c3.5-5.8 5.5-12.5 5.5-19.7V134.2c0-21.1-17.1-38.2-38.2-38.2-6.4 0-12.8 1.6-18.4 4.7L448 157.6v36.5l118.8-65.4c.9-.5 1.9-.8 3-.8 3.4 0 6.2 2.8 6.2 6.2z" />
              </Svg>
            );
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M13 1.7C9.5-1 4.5-.4 1.7 3S-.4 11.5 3 14.3l624 496c3.5 2.7 8.5 2.2 11.2-1.3s2.2-8.5-1.3-11.2zm403 201.2V128c0-35.3-28.7-64-64-64H180.1l20.3 16H352c26.5 0 48 21.5 48 48v109.6l16 12.6zM48 128c0-1.7.1-3.4.3-5l-14.2-11.2Q32 119.6 32 128v256c0 35.3 28.7 64 64 64h256c26.4 0 49-16 58.8-38.8l-13.2-10.4c-6.2 19.3-24.3 33.2-45.6 33.2H96c-26.5 0-48-21.5-48-48zm544 249.8c0 3.5-.8 6.7-2.2 9.6l12.7 10.1c3.5-5.8 5.5-12.5 5.5-19.7V134.2c0-21.1-17.1-38.2-38.2-38.2-6.4 0-12.8 1.6-18.4 4.7L448 157.6v18.3l111.1-61.1c3.3-1.8 7-2.7 10.7-2.7 12.3 0 22.2 9.9 22.2 22.2z" />
              </Svg>
            );

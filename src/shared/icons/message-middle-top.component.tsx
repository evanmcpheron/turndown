      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M343.5 96H448c35.3 0 64 28.7 64 64v288c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V160c0-35.3 28.7-64 64-64h104.5l75.2-90.2c3-3.6 7.5-5.8 12.3-5.8s9.3 2.1 12.3 5.8z" />
              </Svg>
            );
          ...
          case "light":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M343.5 128H448c17.7 0 32 14.3 32 32v288c0 17.7-14.3 32-32 32H64c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h104.5c9.5 0 18.5-4.2 24.6-11.5L256 41l62.9 75.5c6.1 7.3 15.1 11.5 24.6 11.5M268.3 26.3 256 16l12.3 10.2zM168.5 96H64c-35.3 0-64 28.7-64 64v288c0 35.3 28.7 64 64 64h384c35.3 0 64-28.7 64-64V160c0-35.3-28.7-64-64-64H343.5L268.3 5.8c-3-3.7-7.6-5.8-12.3-5.8s-9.3 2.1-12.3 5.8z" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M493.6 445c-11.2 5.3-24.5 3.6-34.1-4.4L288 297.7V416c0 12.4-7.2 23.7-18.4 29s-24.5 3.6-34.1-4.4L64 297.7V416c0 17.7-14.3 32-32 32S0 433.7 0 416V96c0-17.7 14.3-32 32-32s32 14.3 32 32v118.3L235.5 71.4c9.5-7.9 22.8-9.7 34.1-4.4S288 83.6 288 96v118.3L459.5 71.4c9.5-7.9 22.8-9.7 34.1-4.4S512 83.6 512 96v320c0 12.4-7.2 23.7-18.4 29" />
              </Svg>
            );
          ...
          case "light":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M16 64c8.8 0 16 7.2 16 16v135.8L210.6 70.2c5-4 11.2-6.2 17.6-6.2 15.4 0 27.8 12.4 27.8 27.8v150.1L466.6 70.2c5-4 11.2-6.2 17.6-6.2 15.4 0 27.8 12.4 27.8 27.8v328.4c0 15.4-12.4 27.8-27.8 27.8-6.4 0-12.6-2.2-17.6-6.2L256 270.1v150.1c0 15.4-12.4 27.8-27.8 27.8-6.4 0-12.6-2.2-17.6-6.2L32 296.2V432c0 8.8-7.2 16-16 16s-16-7.2-16-16V80c0-8.8 7.2-16 16-16m17.3 192L224 411.4V100.6zM480 100.6 289.3 256 480 411.4z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M459.5 440.6c9.5 7.9 22.8 9.7 34.1 4.4s18.4-16.6 18.4-29V96c0-12.4-7.2-23.7-18.4-29s-24.5-3.6-34.1 4.4L288 214.3V96c0-12.4-7.2-23.7-18.4-29s-24.5-3.6-34.1 4.4L64 214.3v83.3l171.5 143c9.5 7.9 22.8 9.7 34.1 4.4s18.4-16.6 18.4-29V297.7z" />
              </Svg>
            );

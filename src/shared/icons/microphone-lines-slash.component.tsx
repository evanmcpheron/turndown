      ...
      {(() => {
        switch (type) {
          ...
          case "light":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M25.9 3.4C19-2 8.9-.8 3.4 6.1s-4.2 17 2.7 22.5l608 480c6.9 5.5 17 4.3 22.5-2.6s4.3-17-2.6-22.5zm369.6 393.7-28.1-22.2c-14.7 5.8-30.6 9.1-47.4 9.1-70.7 0-128-57.3-128-128v-19.5l-32-25.3V256c0 83 63.1 151.2 144 159.2V480h-64c-8.8 0-16 7.2-16 16s7.2 16 16 16h160c8.8 0 16-7.2 16-16s-7.2-16-16-16h-64v-64.8c21.3-2.1 41.4-8.4 59.5-18.1M256 123.9V96c0-35.3 28.7-64 64-64s64 28.7 64 64h-48c-8.8 0-16 7.2-16 16s7.2 16 16 16h48v32h-48c-8.3 0-15.2 6.4-15.9 14.5l22.1 17.5H384v32h-1.2l33.2 26.2V96c0-53-43-96-96-96s-96 43-96 96v2.7l32 25.3zm190.7 150.6 28.1 22.2c3.4-13 5.2-26.6 5.2-40.7v-48c0-8.8-7.2-16-16-16s-16 7.2-16 16v48c0 6.3-.5 12.4-1.3 18.5" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          ...
          case "light":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M512 23c0-12.7-10.3-23-23-23-2.3 0-4.6.3-6.8 1l-311 95.7C164.6 98.8 160 105 160 112v260.4c-17-12.7-39.4-20.4-64-20.4-53 0-96 35.8-96 80s43 80 96 80 96-35.8 96-80V246.3l288-88.6v150.7c-17-12.7-39.4-20.4-64-20.4-53 0-96 35.8-96 80s43 80 96 80 96-35.8 96-80V23m-32 345c0 21.3-22.9 48-64 48s-64-26.7-64-48 22.9-48 64-48 64 26.7 64 48m-320 64c0 21.3-22.9 48-64 48s-64-26.7-64-48 22.9-48 64-48 64 26.7 64 48m320-307.8-288 88.6v-89l288-88.6z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M416 448c53 0 96-35.8 96-80s-43-80-96-80-96 35.8-96 80 43 80 96 80M96 512c53 0 96-35.8 96-80s-43-80-96-80-96 35.8-96 80 43 80 96 80" />
              </Svg>
            );

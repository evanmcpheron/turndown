      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M256 64c53 0 96 43 96 96s-43 96-96 96-96 43-96 96 43 96 96 96c-106 0-192-86-192-192S150 64 256 64m0 448a256 256 0 1 0 0-512 256 256 0 1 0 0 512m32-352a32 32 0 1 0-64 0 32 32 0 1 0 64 0m-64 192a32 32 0 1 1 64 0 32 32 0 1 1-64 0" />
              </Svg>
            );
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M464 256c0 114.9-93.1 208-208 208-50.9 0-92.2-41.2-92.2-92s41.3-92 92.2-92c77.3 0 140-62.7 140-140 0-15.4-2.5-30.1-7-44 45.9 38.2 75 95.7 75 160M256 48c50.8 0 92 41.2 92 92s-41.2 92-92 92c-77.3 0-140.2 62.6-140.2 140 0 15.3 2.5 30 7 43.8C77.1 377.6 48 320.2 48 256c0-114.9 93.1-208 208-208m0 464a256 256 0 1 0 0-512 256 256 0 1 0 0 512m32-368a32 32 0 1 0-64 0 32 32 0 1 0 64 0m-32 256a32 32 0 1 0 0-64 32 32 0 1 0 0 64" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M0 256C0 114.6 114.6 0 256 0c70.7 0 128 57.3 128 128s-57.3 128-128 128-128 57.3-128 128 57.3 128 128 128C114.6 512 0 397.4 0 256m288 128a32 32 0 1 1-64 0 32 32 0 1 1 64 0M256 96a32 32 0 1 0 0 64 32 32 0 1 0 0-64" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 384 512" fill={colors[colorName || "text"]}>
                <Path d="M384 32c0-9.9-4.5-19.2-12.3-25.2S353.8-1.4 344.2 1l-128 32C202 36.5 192 49.3 192 64v295.7c-14.5-4.9-30.8-7.7-48-7.7-61.9 0-112 35.8-112 80s50.1 80 112 80 112-35.8 112-80V153l103.8-26c14.2-3.5 24.2-16.3 24.2-31z" />
              </Svg>
            );
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 384 512" fill={colors[colorName || "text"]}>
                <Path d="M384 31.1C384 13.9 370.1 0 352.9 0c-2.7 0-5.3.3-7.9 1L193.9 40.8C183.3 43.6 176 53.1 176 64v302.3c-18.1-9-40.2-14.3-64-14.3-61.9 0-112 35.8-112 80s50.1 80 112 80 112-35.8 112-80V195.4l141.9-36.1C376.6 156.6 384 147 384 136zM176 432c0 2.6-1.4 9.4-12.7 17.5-11.2 8-29.2 14.5-51.3 14.5s-40.1-6.5-51.3-14.5C49.4 441.4 48 434.6 48 432s1.4-9.4 12.7-17.5c11.2-8 29.2-14.5 51.3-14.5s40.1 6.5 51.3 14.5c11.3 8.1 12.7 14.9 12.7 17.5m160-314.7-112 28.5V82.5L336 53z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 384 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M144 352a112 80 0 1 0 0 160 112 80 0 1 0 0-160" />
              </Svg>
            );

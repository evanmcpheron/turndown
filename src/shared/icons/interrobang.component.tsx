      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 320 512" fill={colors[colorName || "text"]}>
                <Path d="M144 80c-44.2 0-80 35.8-80 80 0 13.3-10.7 24-24 24s-24-10.7-24-24C16 89.3 73.3 32 144 32h32c70.7 0 128 57.3 128 128v4.6c0 40.1-20.1 77.6-53.4 99.8l-52.3 34.9c-8.9 5.9-14.2 15.9-14.2 26.6v18c0 13.3-10.7 24-24 24s-24-10.7-24-24V168c0-13.3 10.7-24 24-24s24 10.7 24 24v83.2l39.9-26.6c20-13.4 32.1-35.8 32.1-59.9V160c0-44.2-35.8-80-80-80zm-16 368a32 32 0 1 1 64 0 32 32 0 1 1-64 0" />
              </Svg>
            );
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 320 512" fill={colors[colorName || "text"]}>
                <Path d="M136 48C78.6 48 32 94.6 32 152v8c0 4.4-3.6 8-8 8s-8-3.6-8-8v-8C16 85.7 69.7 32 136 32h48c66.3 0 120 53.7 120 120v6.3c0 33.8-16.4 65.5-44 85L195.1 289c-17 12-27.1 31.5-27.1 52.3V368c0 4.4-3.6 8-8 8s-8-3.6-8-8V128c0-4.4 3.6-8 8-8s8 3.6 8 8v165.3c5-6.6 11-12.5 17.9-17.4l64.9-45.8c23.4-16.5 37.3-43.3 37.3-71.9V152c0-57.4-46.6-104-104-104zm8 400a16 16 0 1 1 32 0 16 16 0 1 1-32 0" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 320 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M192 176c0-17.7-14.3-32-32-32s-32 14.3-32 32v144c0 17.7 14.3 32 32 32s32-14.3 32-32zm-32 304a40 40 0 1 0 0-80 40 40 0 1 0 0 80" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          ...
          case "light":
            return (
              <Svg viewBox="0 0 384 512" fill={colors[colorName || "text"]}>
                <Path d="M104.7 32C82.2 32 64 50.2 64 72.7V288H16c-8.8 0-16 7.2-16 16s7.2 16 16 16h48v64H16c-8.8 0-16 7.2-16 16s7.2 16 16 16h48v48c0 8.8 7.2 16 16 16s16-7.2 16-16v-48h208c8.8 0 16-7.2 16-16s-7.2-16-16-16H96v-64h144c79.5 0 144-64.5 144-144S319.5 32 240 32zM96 288V72.7c0-4.8 3.9-8.7 8.7-8.7H240c61.9 0 112 50.1 112 112s-50.1 112-112 112z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 384 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M64 64c0-17.7 14.3-32 32-32h144c79.5 0 144 64.5 144 144s-64.5 144-144 144H128v128c0 17.7-14.3 32-32 32s-32-14.3-32-32V320H32c-17.7 0-32-14.3-32-32s14.3-32 32-32h32zm64 192h112c44.2 0 80-35.8 80-80s-35.8-80-80-80H128z" />
              </Svg>
            );

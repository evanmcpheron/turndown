          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M528 128.1a80 80 0 1 0-160 0 80 80 0 1 0 160 0M519.9 234c-20.5 14-45.3 22.1-71.9 22.1-70.7 0-128-57.3-128-128S377.3.1 448 .1s128 57.3 128 128c0 26.7-8.2 51.4-22.1 71.9l79.1 79.2c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0z" />
              </Svg>
            );

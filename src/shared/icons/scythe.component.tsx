          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M639 24.1C636.1 12.7 627 3.3 614.7.7c-2.2-.5-4.5-.7-6.7-.7h-25.9l-5.4 25.3-7.7 36L520.4 288H416c-17.7 0-32 14.3-32 32s14.3 32 32 32h90.7l-26 121.3c-3.7 17.3 7.3 34.3 24.6 38s34.3-7.3 38-24.6l34.3-160 56.8-265.4 4.8-22.6c1.1-5 .9-10-.3-14.6z" />
              </Svg>
            );

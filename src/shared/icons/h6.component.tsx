          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M537 116c11-13.8 8.8-33.9-5-45s-33.9-8.8-45 5l-98 122.5c-24 29.9-37 67.1-37 105.5 0 79.5 64.5 144 144 144s144-64.5 144-144c0-77.6-61.4-140.9-138.3-143.9zm39 188a80 80 0 1 1-160 0 80 80 0 1 1 160 0" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                <Path d="M134.1 406.1 11.3 283.3C4.1 276.1 0 266.2 0 256s4.1-20.1 11.3-27.3l122.8-122.8c6.4-6.4 15-9.9 24-9.9 18.7 0 33.9 15.2 33.9 33.9V192h128c17.7 0 32 14.3 32 32v64c0 17.7-14.3 32-32 32H192v62.1c0 18.7-15.2 33.9-33.9 33.9-9 0-17.6-3.6-24-9.9M384 416V96c0-17.7 14.3-32 32-32s32 14.3 32 32v320c0 17.7-14.3 32-32 32s-32-14.3-32-32" />
              </Svg>
            );
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                <Path d="M160 146.2 50 256l110 109.8V312c0-13.3 10.7-24 24-24h120v-64H184c-13.3 0-24-10.7-24-24zM0 256c0-11.5 4.6-22.5 12.7-30.6l116.1-115.8c8.7-8.7 20.5-13.6 32.8-13.6 25.6 0 46.4 20.8 46.4 46.4V176h96c26.5 0 48 21.5 48 48v64c0 26.5-21.5 48-48 48h-96v33.6c0 25.6-20.8 46.4-46.4 46.4-12.3 0-24.1-4.9-32.8-13.6L12.7 286.6C4.6 278.5 0 267.5 0 256M400 88c0-13.3 10.7-24 24-24s24 10.7 24 24v336c0 13.3-10.7 24-24 24s-24-10.7-24-24z" />
              </Svg>
            );

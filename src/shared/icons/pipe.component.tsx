      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 64 512" fill={colors[colorName || "text"]}>
                <Path d="M32 0c13.3 0 24 10.7 24 24v464c0 13.3-10.7 24-24 24S8 501.3 8 488V24C8 10.7 18.7 0 32 0" />
              </Svg>
            );
          ...
          case "light":
            return (
              <Svg viewBox="0 0 64 512" fill={colors[colorName || "text"]}>
                <Path d="M32 0c8.8 0 16 7.2 16 16v480c0 8.8-7.2 16-16 16s-16-7.2-16-16V16c0-8.8 7.2-16 16-16" />
              </Svg>
            );
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 64 512" fill={colors[colorName || "text"]}>
                <Path d="M32 0c4.4 0 8 3.6 8 8v496c0 4.4-3.6 8-8 8s-8-3.6-8-8V8c0-4.4 3.6-8 8-8" />
              </Svg>
            );

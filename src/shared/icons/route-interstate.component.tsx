          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M235.1 7.3c12.8-7.8 29-7.8 41.8 0 27.5 16.8 50.2 26 73.4 30 23.3 4 49.2 3.2 83.7-3.2 22.1-4.1 43.6 11 46.9 33.6 6.5 44.2 10 85.6 9.4 124.3H21.2c-.3-38.9 3.4-80.4 9.8-124.3C34.4 45 55.9 30 78 34.1c34.4 6.3 60.3 7.2 83.7 3.2 23.2-4 45.9-13.2 73.4-30" />
              </Svg>
            );

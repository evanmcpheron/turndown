      ...
      {(() => {
        switch (type) {
          ...
          case "light":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                <Path d="M443.3 267.3c6.2-6.2 6.2-16.4 0-22.6l-176-176c-6.2-6.2-16.4-6.2-22.6 0s-6.2 16.4 0 22.6L393.4 240H16c-8.8 0-16 7.2-16 16s7.2 16 16 16h377.4L244.7 420.7c-6.2 6.2-6.2 16.4 0 22.6s16.4 6.2 22.6 0z" />
              </Svg>
            );
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                <Path d="M445.5 261.8c1.6-1.5 2.5-3.6 2.5-5.8s-.9-4.3-2.5-5.8l-192-184c-3.2-3.1-8.3-2.9-11.3.2s-2.9 8.3.2 11.3L420.1 248H8c-4.4 0-8 3.6-8 8s3.6 8 8 8h412.1L242.5 434.2c-3.2 3.1-3.3 8.1-.2 11.3s8.1 3.3 11.3.2l192-184z" />
              </Svg>
            );
            ...
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                <Path
                  ...
                  opacity={opacity || 0.5}
                  d="M338.7 224H32c-17.7 0-32 14.3-32 32s14.3 32 32 32h306.7l32-32z"
                />

      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 576 512" fill={colors[colorName || "text"]}>
                <Path d="M266.4 347.3c31.2-18.9 74.9-43.3 125.9-43.3H448c44.2 0 80-35.8 80-80s-35.8-80-80-80h-55.7c-51 0-94.7-24.4-125.9-43.3C244.7 87.6 219.3 80 192 80c-79.5 0-144 64.5-144 144s64.5 144 144 144c27.3 0 52.7-7.6 74.4-20.7m125.9 4.7c-36.4 0-69.9 17.6-101.1 36.4-11.1 6.7-22.9 12.3-35.2 16.7V456c0 13.3-10.7 24-24 24s-24-10.7-24-24v-40.7c-5.3.4-10.6.7-16 .7-16.6 0-32.7-2.1-48-6v46c0 13.3-10.7 24-24 24s-24-10.7-24-24v-65.7C38.6 357.1 0 295.1 0 224 0 118 86 32 192 32c36.3 0 70.3 10.1 99.2 27.6C322.4 78.4 355.9 96 392.3 96H448c70.7 0 128 57.3 128 128v240c0 7.3-4.9 13.7-12 15.5s-14.5-1.3-18-7.7l-68.4-123.2c-9.5 2.2-19.4 3.4-29.6 3.4zM448 200a24 24 0 1 1 0 48 24 24 0 1 1 0-48" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 576 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M291.2 388.4c31.2-18.8 64.7-36.4 101.1-36.4H448c70.7 0 128-57.3 128-128S518.7 96 448 96h-55.7c-36.4 0-69.9-17.6-101.1-36.4C262.3 42.1 228.3 32 192 32 86 32 0 118 0 224s86 192 192 192c36.3 0 70.3-10.1 99.2-27.6M448 200a24 24 0 1 1 0 48 24 24 0 1 1 0-48" />
              </Svg>
            );

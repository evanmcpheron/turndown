      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                <Path d="M0 96c0-35.3 28.7-64 64-64h320c35.3 0 64 28.7 64 64v224H336c-26.5 0-48 21.5-48 48v112H64c-35.3 0-64-28.7-64-64zm402.7 256H448l-32 32-64 64-32 32V368c0-8.8 7.2-16 16-16zM112 376a24 24 0 1 0-48 0 24 24 0 1 0 48 0M88 112a24 24 0 1 0 0 48 24 24 0 1 0 0-48m24 144a24 24 0 1 0-48 0 24 24 0 1 0 48 0" />
              </Svg>
            );
          ...
          case "light":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                <Path d="M384 64c17.7 0 32 14.3 32 32v208h-96c-26.5 0-48 21.5-48 48v96H64c-17.7 0-32-14.3-32-32V96c0-17.7 14.3-32 32-32zm18.7 272L304 434.7V352c0-8.8 7.2-16 16-16zM64 32C28.7 32 0 60.7 0 96v320c0 35.3 28.7 64 64 64h213.5c17 0 33.3-6.7 45.3-18.7l106.5-106.6c12-12 18.7-28.3 18.7-45.3V96c0-35.3-28.7-64-64-64zm64 344a24 24 0 1 0-48 0 24 24 0 1 0 48 0m-24-264a24 24 0 1 0 0 48 24 24 0 1 0 0-48m24 144a24 24 0 1 0-48 0 24 24 0 1 0 48 0" />
              </Svg>
            );

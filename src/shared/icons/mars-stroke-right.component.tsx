      ...
      {(() => {
        switch (type) {
          ...
          case "light":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M64 256a144 144 0 1 1 288 0 144 144 0 1 1-288 0m319.3-16C375.2 150.3 299.8 80 208 80c-97.2 0-176 78.8-176 176s78.8 176 176 176c91.8 0 167.2-70.3 175.3-160H432v48c0 8.8 7.2 16 16 16s16-7.2 16-16v-48h89.4l-52.7 52.7c-6.2 6.2-6.2 16.4 0 22.6s16.4 6.2 22.6 0l80-80c6.2-6.2 6.2-16.4 0-22.6l-80-80c-6.2-6.2-16.4-6.2-22.6 0s-6.2 16.4 0 22.6l52.7 52.7H464v-48c0-8.8-7.2-16-16-16s-16 7.2-16 16v48z" />
              </Svg>
            );
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M48 256a160 160 0 1 1 320 0 160 160 0 1 1-320 0m335.8-8C379.6 154.5 302.5 80 208 80c-97.2 0-176 78.8-176 176s78.8 176 176 176c94.5 0 171.6-74.5 175.8-168H448v56c0 4.4 3.6 8 8 8s8-3.6 8-8v-56h116.7l-74.3 74.3c-3.1 3.1-3.1 8.2 0 11.3s8.2 3.1 11.3 0l88-88c3.1-3.1 3.1-8.2 0-11.3l-88-88c-3.1-3.1-8.2-3.1-11.3 0s-3.1 8.2 0 11.3l74.3 74.4H464v-56c0-4.4-3.6-8-8-8s-8 3.6-8 8v56z" />
              </Svg>
            );

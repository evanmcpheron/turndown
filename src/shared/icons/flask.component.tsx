      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                <Path d="M288 0H128c-17.7 0-32 14.3-32 32s14.3 32 32 32v132.8c0 11.8-3.3 23.5-9.5 33.5L10.3 406.2C3.6 417.2 0 429.7 0 442.6 0 480.9 31.1 512 69.4 512h309.2c38.3 0 69.4-31.1 69.4-69.4 0-12.8-3.6-25.4-10.3-36.4L329.5 230.4c-6.2-10.1-9.5-21.7-9.5-33.5V64c17.7 0 32-14.3 32-32S337.7 0 320 0zm-96 196.8V64h64v132.8c0 23.7 6.6 46.9 19 67.1l34.5 56.1h-171l34.5-56.1c12.4-20.2 19-43.4 19-67.1" />
              </Svg>
            );
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                <Path d="M176 196.8c0 20.7-5.8 41-16.6 58.7L119.7 320h208.6l-39.7-64.5c-10.9-17.7-16.6-38-16.6-58.7V48h-96zM320 48v148.8c0 11.8 3.3 23.5 9.5 33.5l108.2 175.9a69.54 69.54 0 0 1 10.3 36.4c0 38.3-31.1 69.4-69.4 69.4H69.4C31.1 512 0 480.9 0 442.6c0-12.8 3.6-25.4 10.3-36.4l108.2-175.8c6.2-10.1 9.5-21.7 9.5-33.5V48h-8c-13.3 0-24-10.7-24-24s10.7-24 24-24h208c13.3 0 24 10.7 24 24s-10.7 24-24 24z" />
              </Svg>
            );
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                <Path d="M313.5 230.4c-6.2-10.1-9.5-21.7-9.5-33.5V16h24c4.4 0 8-3.6 8-8s-3.6-8-8-8H120c-4.4 0-8 3.6-8 8s3.6 8 8 8h24v180.8c0 11.8-3.3 23.5-9.5 33.5L10.3 406.2C3.6 417.2 0 429.7 0 442.6 0 480.9 31.1 512 69.4 512h309.2c38.3 0 69.4-31.1 69.4-69.4 0-12.8-3.6-25.4-10.3-36.4zM160 16h128v180.8c0 14.8 4.1 29.3 11.9 41.9.2.3.4.6.6.8l56.7 80.5H90.8l56.8-80.4c.2-.3.4-.6.6-.8 7.8-12.6 11.9-27.1 11.9-41.9V16zm264.3 399c5 8.3 7.7 17.9 7.7 27.6 0 29.5-23.9 53.4-53.4 53.4H69.4C39.9 496 16 472.1 16 442.6c0-9.7 2.7-19.3 7.7-27.6l55.8-79h289z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M309.5 320h-171L64.8 439.8c-.5.9-.8 1.8-.8 2.8 0 3 2.4 5.4 5.4 5.4h309.2a5.378 5.378 0 0 0 4.6-8.2z" />
              </Svg>
            );

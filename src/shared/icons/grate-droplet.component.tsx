          ...
          case "solid":
            return (
              <Svg viewBox="0 0 576 512" fill={colors[colorName || "text"]}>
                <Path d="M0 96c0-35.3 28.7-64 64-64h320c35.3 0 64 28.7 64 64v66.2c-15.1 4.3-28.2 14.6-35.8 28.8l-75.3 141.2A144.6 144.6 0 0 0 320 400c0 29.6 8.9 57.1 24.2 80H64c-35.3 0-64-28.7-64-64V96m96 0H64v128h32zM64 416h32V288H64zm128 0V288h-32v128zm96 0V288h-32v128zm96-320h-32v128h32zm-128 0v128h32V96zm-96 0v128h32V96zm280.5 110.1c4.6-8.7 13.7-14.1 23.5-14.1s18.9 5.4 23.5 14.1l75.3 141.2c8.7 16.2 13.2 34.3 13.2 52.7 0 61.9-50.1 112-112 112s-112-50.1-112-112c0-18.4 4.5-36.5 13.2-52.7z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 576 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="m365.2 347.3 75.3-141.2c4.6-8.7 13.7-14.1 23.5-14.1s18.9 5.4 23.5 14.1l75.3 141.2c8.7 16.2 13.2 34.3 13.2 52.7 0 61.9-50.1 112-112 112s-112-50.1-112-112c0-18.4 4.5-36.5 13.2-52.7" />
              </Svg>
            );

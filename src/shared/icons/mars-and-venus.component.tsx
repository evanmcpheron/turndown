      ...
      {(() => {
        switch (type) {
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M368 8c0 4.4 3.6 8 8 8h92.7l-97.2 97.2C342.3 82.9 301.4 64 256 64c-88.4 0-160 71.6-160 160 0 85.7 67.4 155.6 152 159.8V432h-48c-4.4 0-8 3.6-8 8s3.6 8 8 8h48v56c0 4.4 3.6 8 8 8s8-3.6 8-8v-56h48c4.4 0 8-3.6 8-8s-3.6-8-8-8h-48v-48.2c84.6-4.2 152-74.1 152-159.8 0-37.2-12.7-71.5-34-98.7l98-98V120c0 4.4 3.6 8 8 8s8-3.6 8-8V8c0-4.4-3.6-8-8-8H376c-4.4 0-8 3.6-8 8M256 80a144 144 0 1 1 0 288 144 144 0 1 1 0-288" />
              </Svg>
            );

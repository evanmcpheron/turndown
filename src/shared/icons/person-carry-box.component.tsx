          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 384 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M32 48a48 48 0 1 1 96 0 48 48 0 1 1-96 0m64 193.7v65.1l51 51c7.1 7.1 11.8 16.2 13.4 26.1l15.2 90.9c2.9 17.4-8.9 33.9-26.3 36.8s-33.9-8.9-36.8-26.3l-14.4-85.9L18.7 320C6.7 308 0 291.7 0 274.7v-88.1C0 154.2 26.2 128 58.6 128c24.1 0 46.5 12 59.9 32l42.6 64H224c17.7 0 32 14.3 32 32s-14.3 32-32 32h-71.4c-16 0-31-8-39.9-21.4zM0 480V346.5l64 64V480c0 17.7-14.3 32-32 32S0 497.7 0 480" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M448 144c26.5 0 48 21.5 48 48 5.4 0 10.7.2 16 .7v-.7c0-35.3-28.7-64-64-64H64c-35.3 0-64 28.7-64 64v256c0 35.3 28.7 64 64 64h330.8c-6.9-4.9-13.4-10.2-19.6-16H64c-26.5 0-48-21.5-48-48V192c0-26.5 21.5-48 48-48zm8-80H56c-4.4 0-8 3.6-8 8s3.6 8 8 8h400c4.4 0 8-3.6 8-8s-3.6-8-8-8M408 0H104c-4.4 0-8 3.6-8 8s3.6 8 8 8h304c4.4 0 8-3.6 8-8s-3.6-8-8-8m-40 368a128 128 0 1 1 256 0 128 128 0 1 1-256 0m272 0a144 144 0 1 0-288 0 144 144 0 1 0 288 0m-136-72c0-4.4-3.6-8-8-8s-8 3.6-8 8v64h-64c-4.4 0-8 3.6-8 8s3.6 8 8 8h64v64c0 4.4 3.6 8 8 8s8-3.6 8-8v-64h64c4.4 0 8-3.6 8-8s-3.6-8-8-8h-64z" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 576 512" fill={colors[colorName || "text"]}>
                <Path d="M160 48c-8.8 0-16 7.2-16 16v288c0 8.8 7.2 16 16 16h48c8.8 0 16-7.2 16-16V64c0-8.8-7.2-16-16-16zm-55.4-16c11-19.1 31.7-32 55.4-32h48c23.7 0 44.4 12.9 55.4 32H512c35.3 0 64 28.7 64 64v352c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96c0-35.3 28.7-64 64-64zM96 80H64c-8.8 0-16 7.2-16 16v352c0 8.8 7.2 16 16 16h448c8.8 0 16-7.2 16-16V192H360c-22.1 0-40-17.9-40-40V80h-48v272c0 35.3-28.7 64-64 64h-48c-35.3 0-64-28.7-64-64zm272 0v64h160V96c0-8.8-7.2-16-16-16zm16 192a32 32 0 1 1-64 0 32 32 0 1 1 64 0m-32 128a32 32 0 1 1 0-64 32 32 0 1 1 0 64m128-128a32 32 0 1 1-64 0 32 32 0 1 1 64 0m-32 128a32 32 0 1 1 0-64 32 32 0 1 1 0 64" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 576 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M64 32h32v352c0 17.7 14.3 32 32 32h64c17.7 0 32-14.3 32-32V32h288c35.3 0 64 28.7 64 64v352c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96c0-35.3 28.7-64 64-64m288 64c-17.7 0-32 14.3-32 32v32c0 17.7 14.3 32 32 32h128c17.7 0 32-14.3 32-32v-32c0-17.7-14.3-32-32-32zm-32 192a32 32 0 1 0 64 0 32 32 0 1 0-64 0m160-32a32 32 0 1 0 0 64 32 32 0 1 0 0-64m-32 160a32 32 0 1 0 64 0 32 32 0 1 0-64 0m-96-32a32 32 0 1 0 0 64 32 32 0 1 0 0-64" />
              </Svg>
            );

          ...
          case "solid":
            return (
              <Svg viewBox="0 0 256 512" fill={colors[colorName || "text"]}>
                <Path d="M64 64a64 64 0 1 1 128 0 64 64 0 1 1-128 0M50.7 206.4c7.8-27.5 33-46.4 61.5-46.4h31.4c28.6 0 53.7 18.9 61.5 46.4l39.1 136.8c5.8 20.4-9.5 40.8-30.8 40.8H192v80c0 26.5-21.5 48-48 48h-32c-26.5 0-48-21.5-48-48v-80H42.4c-21.3 0-36.6-20.3-30.8-40.8z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 256 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M112.3 160c-28.6 0-53.7 18.9-61.5 46.4L11.7 343.2C5.8 363.7 21.2 384 42.4 384H64v80c0 26.5 21.5 48 48 48h32c26.5 0 48-21.5 48-48v-80h21.6c21.3 0 36.6-20.3 30.8-40.8l-39.1-136.8c-7.9-27.5-33-46.4-61.5-46.4z" />
              </Svg>
            );

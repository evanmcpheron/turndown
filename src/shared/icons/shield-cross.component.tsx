          ...
          case "solid":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M269.4 2.9C265.2 1 260.7 0 256 0s-9.2 1-13.4 2.9L54.3 82.8c-22 9.3-38.4 31-38.3 57.2.5 99.2 41.3 280.7 213.6 363.2 16.7 8 36.1 8 52.8 0C454.7 420.7 495.5 239.2 496 140c.1-26.2-16.3-47.9-38.3-57.2zM256 66.8l32 13.6V128c0 17.7 14.3 32 32 32h111.3c-1.2 19.6-4.2 41.4-9.4 64H320c-17.7 0-32 14.3-32 32v170.8c-10 6.5-20.7 12.5-32 18-11.3-5.5-22-11.5-32-18V256c0-17.7-14.3-32-32-32H90.1c-5.2-22.6-8.1-44.4-9.4-64H192c17.7 0 32-14.3 32-32V80.3l32-13.6z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="m288 10.8-18.6-7.9C265.2 1 260.7 0 256 0s-9.2 1-13.4 2.9L224 10.8V128c0 17.7-14.3 32-32 32H16.6c1.1 19.4 3.6 41.1 8.1 64H192c17.7 0 32 14.3 32 32v244.4c1.9.9 3.7 1.8 5.6 2.7 16.7 8 36.1 8 52.8 0 1.9-.9 3.8-1.8 5.6-2.7V256c0-17.7 14.3-32 32-32h167.3c4.5-22.9 7.1-44.6 8.1-64H320c-17.7 0-32-14.3-32-32z" />
              </Svg>
            );

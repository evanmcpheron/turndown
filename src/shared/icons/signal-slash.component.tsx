      ...
      {(() => {
        switch (type) {
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M584 8c0-4.4-3.6-8-8-8s-8 3.6-8 8v352.1l16 12.6zM440 504c0 4.4 3.6 8 8 8s8-3.6 8-8v-48.9l-16-12.6zm16-400c0-4.4-3.6-8-8-8s-8 3.6-8 8v155l16 12.6zM312 341.4V504c0 4.4 3.6 8 8 8s8-3.6 8-8V354zM192 288c-4.4 0-8 3.6-8 8v208c0 4.4 3.6 8 8 8s8-3.6 8-8V296c0-4.4-3.6-8-8-8M64 384c-4.4 0-8 3.6-8 8v112c0 4.4 3.6 8 8 8s8-3.6 8-8V392c0-4.4-3.6-8-8-8M13 1.7C9.5-1 4.5-.4 1.7 3S-.4 11.5 3 14.3l624 496c3.5 2.7 8.5 2.2 11.2-1.3s2.2-8.5-1.3-11.2z" />
              </Svg>
            );

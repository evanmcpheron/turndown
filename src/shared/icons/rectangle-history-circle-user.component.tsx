          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M496 512a144 144 0 1 0 0-288 144 144 0 1 0 0 288m0-32c-30.2 0-57.5-11.9-77.7-31.3 6.2-19 24-32.7 45.1-32.7h65.2c21 0 38.9 13.7 45.1 32.7-20.2 19.4-47.5 31.3-77.7 31.3m0-192a48 48 0 1 1 0 96 48 48 0 1 1 0-96" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M640 96v320c0 17.7-14.3 32-32 32s-32-14.3-32-32V96c0-17.7 14.3-32 32-32s32 14.3 32 32M360.5 409.4c-7 6.6-17.2 8.4-26 4.6S320 401.5 320 392v-72H32c-17.7 0-32-14.3-32-32v-64c0-17.7 14.3-32 32-32h288v-72c0-9.6 5.7-18.2 14.5-22s19-2 26 4.6l144 136c4.8 4.5 7.5 10.8 7.5 17.4s-2.7 12.9-7.5 17.4z" />
              </Svg>
            );
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M640 72v368c0 4.4-3.6 8-8 8s-8-3.6-8-8V72c0-4.4 3.6-8 8-8s8 3.6 8 8M320 216H40c-13.3 0-24 10.7-24 24v32c0 13.3 10.7 24 24 24h280c8.8 0 16 7.2 16 16v81.1c0 3.8 3.1 6.9 6.9 6.9 1.8 0 3.5-.7 4.7-1.9l147.6-140.2c.5-.5.8-1.2.8-1.9s-.3-1.4-.8-1.9L347.6 113.9c-1.3-1.2-3-1.9-4.7-1.9-3.8 0-6.9 3.1-6.9 6.9V200c0 8.8-7.2 16-16 16m38.6-113.7 147.6 140.2c3.7 3.5 5.8 8.4 5.8 13.5s-2.1 10-5.8 13.5L358.6 409.7c-4.2 4-9.9 6.3-15.8 6.3-12.6 0-22.9-10.2-22.9-22.9V312H40c-22.1 0-40-17.9-40-40v-32c0-22.1 17.9-40 40-40h280v-81.1c0-12.6 10.2-22.9 22.9-22.9 5.9 0 11.5 2.3 15.8 6.3z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M334.5 414c8.8 3.8 19 2 26-4.6l144-136c4.8-4.5 7.5-10.8 7.5-17.4s-2.7-12.9-7.5-17.4l-144-136c-7-6.6-17.2-8.4-26-4.6S320 110.5 320 120v72H32c-17.7 0-32 14.3-32 32v64c0 17.7 14.3 32 32 32h288v72c0 9.6 5.7 18.2 14.5 22" />
              </Svg>
            );

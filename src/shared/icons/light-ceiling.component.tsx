      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M256 0c17.7 0 32 14.3 32 32v130c115.8 14.4 207.6 106.3 222 222.1 2.2 17.5-12.4 31.9-30 31.9H32c-17.7 0-32.2-14.4-30-31.9C16.4 268.2 108.2 176.4 224 162V32c0-17.7 14.3-32 32-32m0 512c-35.3 0-64-28.7-64-64h128c0 35.3-28.7 64-64 64" />
              </Svg>
            );
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M280 24c0-13.3-10.7-24-24-24s-24 10.7-24 24v137.1C112.4 172.2 16.7 265.6 2 384.1-.2 401.6 14.3 416 32 416h448c17.7 0 32.2-14.4 30-31.9-14.7-118.5-110.5-211.8-230-223zm178.4 344H53.6C75.2 276.3 157.7 208 256 208s180.8 68.3 202.4 160M256 512c35.3 0 64-28.7 64-64H192c0 35.3 28.7 64 64 64" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M256 192C125.4 192 17.7 289.8 2 416.1-.2 433.6 14.3 448 32 448h448c17.7 0 32.2-14.4 30-31.9C494.3 289.8 386.6 192 256 192" />
              </Svg>
            );

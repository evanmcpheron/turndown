      ...
      {(() => {
        switch (type) {
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 576 512" fill={colors[colorName || "text"]}>
                <Path d="M576 176c0 97.2-128.9 176-288 176-30.4 0-59.6-2.9-87.1-8.2 19.5 18.1 31.1 43.8 31.1 71.2 0 53.6-43.4 97-97 97H40c-4.4 0-8-3.6-8-8s3.6-8 8-8h95c44.7 0 81-36.3 81-81 0-30.7-17.3-58.7-44.8-72.4l-30.7-15.4C56.4 296.5 0 240.3 0 176 0 78.8 128.9 0 288 0s288 78.8 288 176M288 336c150.2 0 272-71.6 272-160S438.2 16 288 16 16 87.6 16 176s121.8 160 272 160" />
              </Svg>
            );

          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M441.2 0c-20.6 0-40.2 9-53.7 24.6l-231.6 269c-4.1 4.7-5 11.4-2.4 17.1s8.3 9.3 14.5 9.3h132.9c13.9 0 27.1-6 36.3-16.5l156.6-180.6c11.7-13.5 18.2-30.8 18.2-48.7v-3.4C512 31.7 480.3 0 441.2 0" />
              </Svg>
            );

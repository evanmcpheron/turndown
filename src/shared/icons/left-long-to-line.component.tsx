      ...
      {(() => {
        switch (type) {
          case "solid":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M0 96v320c0 17.7 14.3 32 32 32s32-14.3 32-32V96c0-17.7-14.3-32-32-32S0 78.3 0 96m279.5 313.4c7 6.6 17.2 8.4 26 4.6s14.5-12.5 14.5-22v-72h288c17.7 0 32-14.3 32-32v-64c0-17.7-14.3-32-32-32H320v-72c0-9.6-5.7-18.2-14.5-22s-19-2-26 4.6l-144 136c-4.8 4.5-7.5 10.8-7.5 17.4s2.7 12.9 7.5 17.4z" />
              </Svg>
            );
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                <Path d="M0 72c0-4.4 3.6-8 8-8s8 3.6 8 8v368c0 4.4-3.6 8-8 8s-8-3.6-8-8zm320 224h280c13.3 0 24-10.7 24-24v-32c0-13.3-10.7-24-24-24H320c-8.8 0-16-7.2-16-16v-81.1c0-3.8-3.1-6.9-6.9-6.9-1.8 0-3.5.7-4.7 1.9L144.8 254.1c-.5.5-.8 1.2-.8 1.9s.3 1.4.8 1.9l147.6 140.2c1.3 1.2 3 1.9 4.7 1.9 3.8 0 6.9-3.1 6.9-6.9V312c0-8.8 7.2-16 16-16m-38.6 113.7L133.8 269.5c-3.7-3.5-5.8-8.4-5.8-13.5s2.1-10 5.8-13.5l147.6-140.2c4.3-4 9.9-6.3 15.8-6.3 12.6 0 22.9 10.2 22.9 22.9V200H600c22.1 0 40 17.9 40 40v32c0 22.1-17.9 40-40 40H320v81.1c0 12.6-10.2 22.9-22.9 22.9-5.9 0-11.5-2.3-15.8-6.3z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 640 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M305.5 414c-8.8 3.8-19 2-26-4.6l-144-136c-4.8-4.5-7.5-10.8-7.5-17.4s2.7-12.9 7.5-17.4l144-136c7-6.6 17.2-8.4 26-4.6s14.5 12.5 14.5 22v72h288c17.7 0 32 14.3 32 32v64c0 17.7-14.3 32-32 32H320v72c0 9.6-5.7 18.2-14.5 22" />
              </Svg>
            );

      ...
      {(() => {
        switch (type) {
          ...
          case "thin":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                <Path d="M78.5 35.4c-2-2.9-5.6-4.1-9-3S64 36.5 64 40v216H8c-4.4 0-8 3.6-8 8s3.6 8 8 8h56v200c0 4.4 3.6 8 8 8s8-3.6 8-8V272h145.5l144 204.6c2 2.9 5.6 4.1 9 3s5.6-4.1 5.6-7.6V272h56c4.4 0 8-3.6 8-8s-3.6-8-8-8H384V40c0-4.4-3.6-8-8-8s-8 3.6-8 8v216H233.8zM245 272h123v174.7zm-30.8-16H80V65.3z" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 448 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M86.7 33.4c13.5-4.1 28.1 1.1 35.9 12.9l197.4 296V64c0-17.7 14.3-32 32-32s32 14.3 32 32v384c0 14.1-9.2 26.5-22.7 30.6s-28.1-1.1-35.9-12.9L128 169.7V448c0 17.7-14.3 32-32 32s-32-14.3-32-32V64c0-14.1 9.2-26.5 22.7-30.6" />
              </Svg>
            );

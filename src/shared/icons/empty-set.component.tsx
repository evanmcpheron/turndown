      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M505 41c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-74.6 74.4C358.1 50.6 309.2 32 256 32 132.3 32 32 132.3 32 256c0 53.2 18.6 102.1 49.5 140.5L7 471c-9.4 9.4-9.4 24.6 0 33.9s24.6 9.4 33.9 0l74.5-74.5c38.4 31 87.3 49.5 140.5 49.5 123.7 0 224-100.3 224-224 0-53.2-18.6-102.1-49.5-140.5zm-142.7 74.7L115.7 362.3C93.3 332.8 80 295.9 80 256c0-97.2 78.8-176 176-176 39.9 0 76.8 13.3 106.3 35.7M149.7 396.3l246.6-246.6C418.7 179.2 432 216.1 432 256c0 97.2-78.8 176-176 176-39.9 0-76.8-13.3-106.3-35.7" />
              </Svg>
            );
          ...
          case "duotone":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                ...
                />
                <Path d="M502.6 9.4c12.5 12.5 12.5 32.8 0 45.3l-448 448c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l448-448c12.5-12.5 32.8-12.5 45.3 0" />
              </Svg>
            );

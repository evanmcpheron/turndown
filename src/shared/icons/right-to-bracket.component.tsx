      ...
      {(() => {
        switch (type) {
          ...
          case "regular":
            return (
              <Svg viewBox="0 0 512 512" fill={colors[colorName || "text"]}>
                <Path d="M192 365.8 302 256 192 146.2V200c0 13.3-10.7 24-24 24H48v64h120c13.3 0 24 10.7 24 24zM352 256c0 11.5-4.6 22.5-12.7 30.6L223.2 402.4c-8.7 8.7-20.5 13.6-32.8 13.6-25.6 0-46.4-20.8-46.4-46.4V336H48c-26.5 0-48-21.5-48-48v-64c0-26.5 21.5-48 48-48h96v-33.6c0-25.6 20.8-46.4 46.4-46.4 12.3 0 24.1 4.9 32.8 13.6l116.1 115.8c8.1 8.1 12.7 19.1 12.7 30.6m-8 176h80c22.1 0 40-17.9 40-40V120c0-22.1-17.9-40-40-40h-80c-13.3 0-24-10.7-24-24s10.7-24 24-24h80c48.6 0 88 39.4 88 88v272c0 48.6-39.4 88-88 88h-80c-13.3 0-24-10.7-24-24s10.7-24 24-24" />
              </Svg>
            );
